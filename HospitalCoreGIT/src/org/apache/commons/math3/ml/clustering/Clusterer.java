...
public abstract class Clusterer<T extends Clusterable> {
    ...
    /**
     * Perform a cluster analysis on the given set of {@link Clusterable}
     * instances.
     *
     * @param points
     ...
     *             if points are null or the number of data points is not
     *             compatible with this clusterer
     * @throws ConvergenceException
     *             if the algorithm has not yet converged after the maximum
