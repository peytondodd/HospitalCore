 ...
 * <p>
 * The Fuzzy K-Means algorithm is a variation of the classical K-Means
 * algorithm, with the major difference that a single data point is not uniquely
 * assigned to a single cluster. Instead, each point i has a set of weights
 * u<sub>ij</sub> which indicate the degree of membership to the cluster j.
 * <p>
 ...
 * </pre>
 * 
 * with d<sub>ik</sub> being the distance between data point i and the cluster
 * center k.
 * <p>
 * The algorithm requires two parameters:
 * <ul>
 * <li>k: the number of clusters
 * <li>fuzziness: determines the level of cluster fuzziness, larger values lead
 * to fuzzier clusters
 * </ul>
 ...
 * </ul>
 * <p>
 * The fuzzy variant of the K-Means algorithm is more robust with regard to the
...
public class FuzzyKMeansClusterer<T extends Clusterable> extends Clusterer<T> {
     ...
     * <p>
     * The element U<sub>i,j</sub> represents the membership value for data
     * point {@code i} to cluster {@code j}.
     *
     ...
     * {@link #cluster(Collection)}.
     * 
     * @return the list of data points, or {@code null} if
     *         {@link #cluster(Collection)} has not been called before.
     */
     ...
     * {@link #cluster(Collection)}.
     * 
     * @return the list of clusters, or {@code null} if
     *         {@link #cluster(Collection)} has not been called before.
     */
