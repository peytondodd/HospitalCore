...
public abstract class ClusterEvaluator<T extends Clusterable> {
    ...
    /**
     * Creates a new cluster evaluator with an {@link EuclideanDistance} as
     * distance measure.
     */
     ...
     * <p>
     * Specific implementations shall override this method if the returned
     * scores do not follow the same ordering, i.e. smaller score is better.
     *
     * @param score1
     *            the first score
     * @param score2
     *            the second score
     * @return {@code true} if the first score is considered to be better,
     ...
     * the configured {@link DistanceMeasure}.
     *
     * @param p1
     ...
     * @param cluster
     *            the cluster
     * @return the computed centroid for the cluster, or {@code null} if the
	...
	// in case the cluster is of type CentroidCluster, no need to compute
	// the centroid
