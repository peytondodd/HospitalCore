...
public class MultiKMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
    ...
    /**
     * Returns the {@link ClusterEvaluator} used to determine the "best"
     * clustering.
     * 
     ...
     *             if an empty cluster is encountered and the underlying
     *             {@link KMeansPlusPlusClusterer} has its
     *             {@link KMeansPlusPlusClusterer.EmptyClusterStrategy} is set
     *             to {@code ERROR}.
     */
    @Override
