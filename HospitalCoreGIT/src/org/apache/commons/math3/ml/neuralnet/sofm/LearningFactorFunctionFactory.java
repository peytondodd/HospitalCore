...
public class LearningFactorFunctionFactory {
    ...
    /**
     * Creates an exponential decay {@link LearningFactorFunction function}. It
     * will compute <code>a e<sup>-x / b</sup></code>, where {@code x} is the
     * (integer) independent variable and
     * <ul>
     ...
     *
     * @param initValue
     *            Initial value, i.e. {@link LearningFactorFunction#value(long)
     *            value(0)}.
	...
	return new LearningFactorFunction() {
	    /** DecayFunction. */
	    private final ExponentialDecayFunction decay = new ExponentialDecayFunction(initValue, valueAtNumCall,
		    numCall);
    ...
    /**
     * Creates an sigmoid-like {@code LearningFactorFunction function}. The
     * function {@code f} will have the following properties:
     * <ul>
