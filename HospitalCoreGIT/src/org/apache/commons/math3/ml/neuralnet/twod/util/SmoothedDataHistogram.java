...
/**
 * Visualization of high-dimensional data projection on a 2D-map. The method is
 * described in <quote> <em>Using Smoothed Data Histograms for Cluster
 * Visualization in Self-Organizing Maps</em> <br>
 * by Elias Pampalk, Andreas Rauber and Dieter Merkl. </quote>
 * 
 * @since 3.6
 */
public class SmoothedDataHistogram implements MapDataVisualization {
     ...
     *             if the size of the {@code map} is smaller than the number of
     *             {@link #SmoothedDataHistogram(int,DistanceMeasure) smoothing
     *             bins}.
     */
