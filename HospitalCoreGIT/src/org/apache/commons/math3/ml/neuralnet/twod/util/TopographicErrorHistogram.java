...
/**
 * Computes the topographic error histogram. Each bin will contain the number of
 * data for which the first and second best matching units are not adjacent in
 * the map.
 * 
 * @since 3.6
 */
public class TopographicErrorHistogram implements MapDataVisualization {
    ...
    /**
     * @param relativeCount
     *            Whether to compute relative bin counts. If {@code true}, the
     *            data count in each bin will be divided by the total number of
     *            samples mapped to the neuron represented by that bin.
     * @param distance
     *            Distance.
     */
