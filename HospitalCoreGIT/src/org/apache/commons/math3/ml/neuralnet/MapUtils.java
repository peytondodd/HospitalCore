...
public class MapUtils {
     ...
     *            Data.
     * @param neurons
     *            List of neurons to scan. If the list is empty {@code null}
     *            will be returned.
     * @param distance
     *            Distance function. The neuron's features are passed as the
     *            first argument to
     *            {@link DistanceMeasure#compute(double[],double[])}.
     * @return the neuron whose features are closest to the given data.
     * @throws org.apache.commons.math3.exception.DimensionMismatchException
     *             if the size of the input is not compatible with the neurons
     *             features size.
     */
    ...
    /**
     * Creates a list of neurons sorted in increased order of the distance to
     * the given {@code features}.
     *
     * @param features
     *            Data.
     * @param neurons
     *            List of neurons to scan. If it is empty, an empty array will
     *            be returned.
     * @param distance
     *            Distance function.
     ...
     *            Network.
     * @param distance
     *            Function to use for computing the average distance from a
     *            neuron to its neighbours.
    ...
    /**
     * Computes the quantization error. The quantization error is the average
     * distance between a feature vector and its "best matching unit" (closest
     * neuron).
     *
     * @param data
     *            Feature vectors.
    ...
    /**
     * Computes the topographic error. The topographic error is the proportion
     * of data for which first and second best matching units are not adjacent
     * in the map.
     *
     * @param data
     *            Feature vectors.
