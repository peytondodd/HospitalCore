...
public class FeatureInitializerFactory {
     ...
     * @param rng
     *            Random number generator used to draw samples from a uniform
     *            distribution.
    ...
    /**
     * Creates an initializer from a univariate function {@code f(x)}. The
     * argument {@code x} is set to {@code init} at the first call and will be
