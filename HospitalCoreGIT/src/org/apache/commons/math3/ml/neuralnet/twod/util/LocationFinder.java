...
public class LocationFinder {
    ...
    /**
     * Builds a finder to retrieve the locations of neurons that belong to the
     * given {@code map}.
     *
     * @param map
     *            Map.
     ...
     *             if the network contains non-unique identifiers. This
     *             indicates an inconsistent state due to a bug in the
     *             construction code of the underlying
     *             {@link org.apache.commons.math3.ml.neuralnet.Network
     *             network}.
     */
     ...
     * @param n
     *            Neuron.
     * @return the (row, column) coordinates of {@code n}, or {@code null} if no
     *         such neuron belongs to the
     *         {@link #LocationFinder(NeuronSquareMesh2D) map used to build this
     *         instance}.
     */
