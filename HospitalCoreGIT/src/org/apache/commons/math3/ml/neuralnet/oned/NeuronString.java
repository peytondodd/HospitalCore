...
/**
 * Neural network with the topology of a one-dimensional line. Each neuron
 * defines one point on the line.
 *
 * @since 3.3
 */
public class NeuronString implements Serializable {
    ...
    /**
     * Mapping of the 1D coordinate to the neuron identifiers (attributed by the
     ...
     *
     * @param wrap
     *            Whether to wrap the dimension (i.e the first and last neurons
    ...
    /**
     * Creates a one-dimensional network: Each neuron not located on the border
     * of the mesh has two neurons linked to it. <br/>
     * The links are bi-directional. Neurons created successively are neighbours
     * (i.e. there are links between them). <br/>
     * The topology of the network can also be a circle (if the dimension is
     * wrapped).
     *
     * @param num
     *            Number of neurons.
    ...
    /**
     * Retrieves the features set from the neuron at location {@code i} in the
     * map.
     *
     * @param i
     *            Neuron index.
