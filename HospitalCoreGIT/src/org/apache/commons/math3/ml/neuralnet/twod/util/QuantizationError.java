...
/**
 * Computes the quantization error histogram. Each bin will contain the average
 * of the distances between samples mapped to the corresponding unit and the
 * weight vector of that unit.
 * 
 * @since 3.6
 */
