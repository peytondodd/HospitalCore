 ...
 * the <code>X</code> matrix. (See {@link QRDecomposition} for details on the
 * decomposition algorithm.) The <code>X</code> matrix, also known as the
 * <i>design matrix,</i> has rows corresponding to sample observations and
 * columns corresponding to independent variables. When the model is estimated
 * using an intercept term (i.e. when {@link #isNoIntercept() isNoIntercept} is
 * false as it is by default), the <code>X</code> matrix includes an initial
 * column identically equal to 1. We solve the normal equations as follows:
 * 
 * <pre>
 ...
 *
 * <p>
 * Given <code>Q</code> and <code>R</code>, the last equation is solved by
 * back-substitution.
 * </p>
 *
 * @since 2.0
...
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
     ...
     * {@inheritDoc}
     * <p>
     * This implementation computes and caches the QR decomposition of the X
     * matrix.
     * </p>
     */
    @Override
     ...
     *             unless method {@code newSampleData} has been called
     *             beforehand.
     */
	...
	// No try-catch or advertised NotStrictlyPositiveException - NPE above
	// if n < 3
     ...
     *
     * <p>
     * If the model has no intercept term, <code>0</code> is used for the mean
     * of Y - i.e., what is returned is the sum of the squared Y values.
     * </p>
     *
     * <p>
     ...
     * </pre>
     * 
     * where SSR is the {@link #calculateResidualSumOfSquares() sum of squared
     * residuals} and SSTO is the {@link #calculateTotalSumOfSquares() total sum
     * of squares}
     *
     * <p>
     ...
     * 
     * where SSR is the {@link #calculateResidualSumOfSquares() sum of squared
     * residuals}, SSTO is the {@link #calculateTotalSumOfSquares() total sum of
     ...
     * <p>
     * This implementation computes and caches the QR decomposition of the X
     * matrix once it is successfully loaded.
     * </p>
     */
    @Override
