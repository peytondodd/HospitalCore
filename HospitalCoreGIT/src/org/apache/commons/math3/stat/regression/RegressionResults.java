...
public class RegressionResults implements Serializable {
     ...
     * @param varcov
     *            the variance covariance matrix, stored either in a square
     *            matrix or as a compressed
     * @param isSymmetricCompressed
     *            a flag which denotes that the variance covariance matrix is in
     ...
     * @param copyData
     *            if true a deep copy of all input data is made, if false only
     *            references are copied and the RegressionResults become mutable
     */
     ...
     *
     * <p>
     * A redundant regressor will have its redundancy flag set, as well as a
     * parameters estimated equal to {@code Double.NaN}
     * </p>
     *
     * @param index
     *            Index.
     ...
     *
     * <p>
     * A redundant regressor will have its redundancy flag set, as will a
     * parameter estimate equal to {@code Double.NaN}.
     * </p>
     *
     ...
     * error of the parameter estimate at index</a>, usually denoted
     * s(b<sub>index</sub>).
     *
     * @param index
     *            Index.
     * @return the standard errors associated with parameters estimated at
     *         index.
     * @throws OutOfRangeException
     *             if {@code index} is not in the interval
     *             {@code [0, number of parameters)}.
     ...
     * <p>
     * Returns the <a href="http://www.xycoon.com/standerrorb(1).htm">standard
     * error of the parameter estimates</a>, usually denoted s(b<sub>i</sub>).
     * </p>
     *
     * <p>
     * If there are problems with an ill conditioned design matrix then the
     * regressor which is redundant will be assigned <code>Double.NaN</code>.
     * </p>
     *
     ...
     * <p>
     * If there are problems with an ill conditioned design matrix then the
     * covariance which involves redundant columns will be assigned
     * {@code Double.NaN}.
     * </p>
     *
     * @param i
     ...
     * @throws OutOfRangeException
     *             if {@code i} or {@code j} is not in the interval
     *             {@code [0, number of parameters)}.
     */
     ...
     *
     * @return Number of observations, -1 if an error condition prevents
     *         estimation
     */
    public long getN() {
	return this.nobs;
     ...
     * <strong>Preconditions</strong>:
     * <ul>
     * <li>numberOfParameters data pairs must have been added before invoking
     * this method. If this method is invoked before a model can be estimated,
     * <code>Double,NaN</code> is returned.</li>
     * </ul>
     * </p>
     *
     ...
     *
     * <p>
     * If there are fewer than <strong>numberOfParameters + 1</strong> data
     * pairs in the model, or if there is no variation in <code>x</code>, this
     ...
     * of multiple determination</a>, usually denoted r-square.
     * </p>
     *
     * <p>
     * <strong>Preconditions</strong>:
     * <ul>
     * <li>At least numberOfParameters observations (with at least
     * numberOfParameters different x values) must have been added before
     * invoking this method. If this method is invoked before a model can be
     * estimated, {@code Double,NaN} is returned.</li>
     * </ul>
     * </p>
     *
     ...
     * </pre>
     * 
     * where SSR is the sum of squared residuals}, SSTO is the total sum of
     * squares}, n is the number of observations and p is the number of
     * parameters estimated (including the intercept).
     * </p>
     *
     * <p>
     * If the regression is estimated without an intercept term, what is
     * returned is
     * 
     * <pre>
    ...
    /**
     * Returns true if the regression model has been computed including an
     * intercept. In this case, the coefficient of the intercept is the first
     * element of the {@link #getParameterEstimates() parameter estimates}.
     * 
