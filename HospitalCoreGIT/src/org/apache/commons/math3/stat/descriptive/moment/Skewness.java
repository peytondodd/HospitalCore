 ...
 * </p>
 * <p>
 * Note that this statistic is undefined for n < 3. <code>Double.Nan</code> is
...
public class Skewness extends AbstractStorelessUnivariateStatistic implements Serializable {
     ...
     * {@inheritDoc}
     * <p>
     * Note that when {@link #Skewness(ThirdMoment)} is used to create a
     * Skewness, this method does nothing. In that case, the ThirdMoment should
