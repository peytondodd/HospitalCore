...
public class DescriptiveStatistics implements StatisticalSummary, Serializable {
     ...
     *             if window size is less than 1 but not equal to
     *             {@link #INFINITE_WINDOW}
     */
     ...
     *         any negative values have been added.
     */
     ...
     * 
     * @return The quadratic mean or {@code Double.NaN} if no values have been
     *         added.
     */
    ...
    /**
     * WindowSize controls the number of values that contribute to the reported
     ...
     * based on these values. If {@code windowSize} is decreased as a result of
     * this call and there are more than the new value of elements in the
	...
	if (percentileImpl instanceof Percentile) {
		...
		throw new MathIllegalStateException(LocalizedFormats.PERCENTILE_IMPLEMENTATION_UNSUPPORTED_METHOD,
			percentileImpl.getClass().getName(), SET_QUANTILE_METHOD_NAME);
	    } catch (IllegalAccessException e2) {
		throw new MathIllegalStateException(LocalizedFormats.PERCENTILE_IMPLEMENTATION_CANNOT_ACCESS_METHOD,
	...
	try {
	    ...
	    throw new MathIllegalArgumentException(LocalizedFormats.PERCENTILE_IMPLEMENTATION_UNSUPPORTED_METHOD,
		    percentileImpl.getClass().getName(), SET_QUANTILE_METHOD_NAME);
	} catch (IllegalAccessException e2) {
	    throw new MathIllegalArgumentException(LocalizedFormats.PERCENTILE_IMPLEMENTATION_CANNOT_ACCESS_METHOD,
		    SET_QUANTILE_METHOD_NAME, percentileImpl.getClass().getName());
	} catch (InvocationTargetException e3) {
	...
	// No try-catch or advertised exception because parms are guaranteed
	// valid
	copy(this, result);
	return result;
    }
