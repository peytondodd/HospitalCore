 ...
 * returned when there is not sufficient data to compute the statistic. Note
 * that Double.NaN may also be returned if the input includes NaN and / or
 * infinite values.
 * </p>
 * <p>
...
public class Kurtosis extends AbstractStorelessUnivariateStatistic implements Serializable {
     ...
     * {@inheritDoc}
     * <p>
     * Note that when {@link #Kurtosis(FourthMoment)} is used to create a
     * Variance, this method does nothing. In that case, the FourthMoment should
