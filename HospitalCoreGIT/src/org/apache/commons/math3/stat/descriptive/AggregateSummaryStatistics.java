...
/**
 * <p>
 * An aggregator for {@code SummaryStatistics} from several data sets or data
 * set partitions. In its simplest usage mode, the client creates an instance
 * via the zero-argument constructor, then uses
 ...
 * aggregate statistics directly from a Collection of SummaryStatistics
 * instances.
 * </p>
 * <p>
 * When {@link #createContributingStatistics()} is used to create
 * SummaryStatistics instances to be aggregated concurrently, the created
 * instances' {@link SummaryStatistics#addValue(double)} methods must
 * synchronize on the aggregating instance maintained by this class. In
 * multithreaded environments, if the functionality provided by
 * {@link #aggregate(Collection)} is adequate, that method should be used to
 * avoid unnecessary computation and synchronization delays.
 * </p>
 *
 * @since 2.0
 *
...
public class AggregateSummaryStatistics implements StatisticalSummary, Serializable {
	...
	// No try - catch or advertising NAE because neither argument will ever
	// be null
