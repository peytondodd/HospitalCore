...
public interface WeightedEvaluation {
     ...
     *             if either array is null, lengths do not match, weights
     *             contain NaN, negative or infinite values, or weights does not
     ...
     *         entries
     * @throws MathIllegalArgumentException
     *             if either array is null, lengths do not match, indices are
     *             invalid, weights contain NaN, negative or infinite values, or
