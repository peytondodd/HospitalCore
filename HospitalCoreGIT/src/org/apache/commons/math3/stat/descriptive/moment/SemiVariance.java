...
/**
 * <p>
 * Computes the semivariance of a set of values with respect to a given cutoff
 * value. We define the <i>downside semivariance</i> of a set of values
 * <code>x</code> against the <i>cutoff value</i> <code>cutoff</code> to be
 * <br/>
 * <code>&Sigma; (x[i] - target)<sup>2</sup> / df</code> <br/>
 * where the sum is taken over all <code>i</code> such that
 * <code>x[i] < cutoff</code> and <code>df</code> is the length of
 * <code>x</code> (non-bias-corrected) or one less than this number (bias
 * corrected). The <i>upside semivariance</i> is defined similarly, with the sum
 * taken over values of <code>x</code> that exceed the cutoff value.
 * </p>
 *
 * <p>
 * The cutoff value defaults to the mean, bias correction defaults to
 * <code>true</code> and the "variance direction" (upside or downside) defaults
 * to downside. The variance direction and bias correction may be set using
 * property setters or their values can provided as parameters to
 * {@link #evaluate(double[], double, Direction, boolean, int, int)}.
 * </p>
 *
 * <p>
 * If the input array is null, <code>evaluate</code> methods throw
 * <code>IllegalArgumentException.</code> If the array has length 1,
 * <code>0</code> is returned, regardless of the value of the
 * <code>cutoff.</code>
 *
 * <p>
...
public class SemiVariance extends AbstractUnivariateStatistic implements Serializable {
    ...
    /**
     * The DOWNSIDE Direction is used to specify that the observations below the
     * cutoff point will be used to calculate SemiVariance
     */
    ...
    /**
     * Constructs a SemiVariance with the specified <code>Direction</code>
     * property and default (true) <code>biasCorrected</code> property
     *
     * @param direction
    ...
    /**
     * Copy constructor, creates a new {@code SemiVariance} identical to the
     * {@code original}
     *
     * @param original
    ...
    /**
     * <p>
     * Returns the {@link SemiVariance} of the designated values against the
     * mean, using instance properties varianceDirection and biasCorrection.
     * </p>
     *
     * <p>
    ...
    /**
     * This method calculates {@link SemiVariance} for the entire array against
     * the mean, using the current value of the biasCorrection instance
     * property.
     *
     * @param values
     *            the input array
     ...
     * <p>
     * Returns the {@link SemiVariance} of the designated values against the
     * cutoff, using instance properties variancDirection and biasCorrection.
     * </p>
     *
     * <p>
     * Returns <code>NaN</code> if the array is empty and throws
     ...
     * <p>
     * Returns the {@link SemiVariance} of the designated values against the
     * cutoff in the given direction, using the current value of the
     * biasCorrection instance property.
     * </p>
     *
     * <p>
     * Returns <code>NaN</code> if the array is empty and throws
     ...
     * <p>
     * Returns the {@link SemiVariance} of the designated values against the
     * cutoff in the given direction with the provided bias correction.
     * </p>
     *
     * <p>
     * Returns <code>NaN</code> if the array is empty and throws
     ...
     * direction is represented by boolean, with true corresponding to UPSIDE
     * semivariance.
     */
    public enum Direction {
	/**
	 * The UPSIDE Direction is used to specify that the observations above
	 ...
	 *
	 * @param b
	 *            boolean value representing the Direction. True corresponds
	 *            to UPSIDE.
	 */
	Direction(boolean b) {
	    direction = b;
