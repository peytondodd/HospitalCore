...
public class SummaryStatistics implements StatisticalSummary, Serializable {
     ...
     * {@link #addValue(double) addValue} has been used to add data. If it is
     * activated after data has been added, an IllegalStateException will be
     * thrown.
     * </p>
     * 
     * @param sumImpl
	...
	// No try-catch or advertised exception because arguments are guaranteed
	// non-null
	copy(this, result);
	return result;
    }
