...
public final class StatUtils {
     ...
     * <p>
     * See
     * {@link org.apache.commons.math3.stat.descriptive.moment.GeometricMean}
     ...
     * {@code n - 1} in the denominator). Use
     * {@link #populationVariance(double[])} for the non-bias-corrected
     * population variance.
     * </p>
     * <p>
     ...
     * This method returns the bias-corrected sample variance (using
     * {@code n - 1} in the denominator). Use
     * {@link #populationVariance(double[], int, int)} for the
     ...
     * This method returns the bias-corrected sample variance (using
     * {@code n - 1} in the denominator). Use
     * {@link #populationVariance(double[], double, int, int)} for the
     * non-bias-corrected population variance.
     * </p>
     * <p>
     * See {@link org.apache.commons.math3.stat.descriptive.moment.Variance} for
     ...
     * This method returns the bias-corrected sample variance (using
     * {@code n - 1} in the denominator). Use
     * {@link #populationVariance(double[], double)} for the non-bias-corrected
     * population variance.
     * </p>
     * <p>
     * See {@link org.apache.commons.math3.stat.descriptive.moment.Variance} for
    ...
    /**
     * Returns the
     * <a href="http://en.wikibooks.org/wiki/Statistics/Summary/Variance">
     ...
     * @param values
     *            the input array
     * @return the population variance of the values or Double.NaN if the array
     *         is empty
     * @throws MathIllegalArgumentException
     *             if the array is null
     */
     ...
     * Returns the
     * <a href="http://en.wikibooks.org/wiki/Statistics/Summary/Variance">
     * population variance</a> of the entries in the specified portion of the
     * input array, or <code>Double.NaN</code> if the designated subarray is
     * empty.
     * <p>
     * See {@link org.apache.commons.math3.stat.descriptive.moment.Variance} for
     ...
     * <a href="http://en.wikibooks.org/wiki/Statistics/Summary/Variance">
     * population variance</a> of the entries in the specified portion of the
     * input array, using the precomputed mean value. Returns
    ...
    /**
     * Normalize (standardize) the sample, so it is has a mean of 0 and a
     ...
     * this value is returned as the only element of the output array.
     * Otherwise, the returned array contains the maximum frequency elements in
     * increasing order. For example, if {@code sample} is {0, 12, 5, 6, 0, 13,
     * 5, 17}, the returned array will have length two, with 0 in the first
     * element and 5 in the second.
     *
     * <p>
     ...
     * @param sample
     *            input data
     * @return array of array of the most frequently occurring element(s) sorted
     *         in ascending order.
     * @throws MathIllegalArgumentException
