...
public class Covariance {
     ...
     *
     * <p>
     * The input array must be rectangular with at least one column and two
     * rows.
     * </p>
     *
     * @param data
     ...
     *             if the input data array is not rectangular with at least one
     *             row and one column.
     */
     ...
     *            true means covariances are bias-corrected
     * @throws MathIllegalArgumentException
     *             if the input matrix does not have at least two rows and one
     *             column
     */
     ...
     *            matrix to check
     * @throws MathIllegalArgumentException
     *             if the matrix does not contain sufficient data to compute
     *             covariance
     */
