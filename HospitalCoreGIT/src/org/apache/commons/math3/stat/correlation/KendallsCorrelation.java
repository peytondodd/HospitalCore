 ...
 * <li>n<sub>1</sub> = sum of t<sub>i</sub> * (t<sub>i</sub> - 1) / 2 for all
 * i</li>
 * <li>n<sub>2</sub> = sum of u<sub>j</sub> * (u<sub>j</sub> - 1) / 2 for all
 * j</li>
...
public class KendallsCorrelation {
    ...
    /**
     * Returns the sum of the number from 1 .. n according to Gauss' summation
     * formula: \[ \sum\limits_{k=1}^n k = \frac{n(n + 1)}{2} \]
     *
     * @param n
     *            the summation end
