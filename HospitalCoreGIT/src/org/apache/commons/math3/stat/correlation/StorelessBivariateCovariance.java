 ...
 * SAND2008-6212, Sandia National Laboratories. It computes the covariance for a
 * pair of variables. Use {@link StorelessCovariance} to estimate an entire
 * covariance matrix.
 * </p>
 *
 * <p>
 * Note: This class is package private as it is only used internally in the
 * {@link StorelessCovariance} class.
 * </p>
 *
 * @since 3.0
 */
class StorelessBivariateCovariance {
    ...
    /**
     * Create an empty {@link StorelessBivariateCovariance} instance with bias
     * correction.
     */
    ...
    /**
     * Appends another bivariate covariance calculation to this. After this
     * operation, statistics returned should be close to what would have been
     * obtained by by performing all of the {@link #increment(double, double)}
