 ...
 *
 * <p>
 * This is known in statistical genetics as the McDonald-Kreitman test. The
 * implementation handles both known and unknown distributions.
 * </p>
 *
 * <p>
 * Two samples tests can be used when the distribution is unknown <i>a
 * priori</i> but provided by one sample, or when the hypothesis under test is
 * that the two samples come from the same underlying distribution.
 * </p>
 *
 * @since 3.1
 */
public class GTest {
     ...
     * p-value</a>, associated with a G-Test for goodness of fit</a> comparing
     * the {@code observed} frequency counts to those in the {@code expected}
     * array.
     *
     * <p>
     ...
     * in p64-69 of McDonald, J.H. 2009. Handbook of Biological Statistics (2nd
     * ed.). Sparky House Publishing, Baltimore, Maryland.
     *
     * <p>
     * The probability returned is the tail probability beyond
     * {@link #g(double[], long[]) g(expected, observed)} in the ChiSquare
     * distribution with degrees of freedom two less than the common length of
     * {@code expected} and {@code observed}.
     * </p>
     *
     * @param observed
     ...
     *             if {@code observed} has negative entries
     * @throws NotStrictlyPositiveException
     *             {@code expected} has entries that are not strictly positive
     * @throws DimensionMismatchException
     *             if the array lengths do not match or are less than 2.
     * @throws MaxCountExceededException
     *             if an error occurs computing the p-value.
