 ...
 *
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Binomial_proportion_confidence_interval">Binomial
...
public interface BinomialConfidenceInterval {
     ...
     * unknown binomial distribution with the given observed number of trials,
     * successes and confidence level.
     * <p>
     * Preconditions:
     * <ul>
     * <li>{@code numberOfTrials} must be positive</li>
     * <li>{@code numberOfSuccesses} may not exceed {@code numberOfTrials}</li>
     * <li>{@code confidenceLevel} must be strictly between 0 and 1
     * (exclusive)</li>
     * </ul>
     * </p>
     *
     ...
     *            desired probability that the true probability of success falls
     ...
     *             if {@code confidenceLevel} is not in the interval
     *             {@code (0, 1)}.
     */
