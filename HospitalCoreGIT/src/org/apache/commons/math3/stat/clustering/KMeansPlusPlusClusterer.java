 ...
 *             {@link org.apache.commons.math3.ml.clustering.KMeansPlusPlusClusterer}
 *             instead
 */
@Deprecated
public class KMeansPlusPlusClusterer<T extends Clusterable<T>> {
     ...
     *            the maximum number of iterations to run the algorithm for at
     *            each trial run. If negative, no maximum will be used
