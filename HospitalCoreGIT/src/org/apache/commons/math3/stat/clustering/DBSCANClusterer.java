 ...
 * </ul>
 * <p>
 * <b>Note:</b> as DBSCAN is not a centroid-based clustering algorithm, the
 * resulting {@link Cluster} objects will have no defined center, i.e.
 * {@link Cluster#getCenter()} will return {@code null}.
 *
 * @param <T>
 ...
 * @since 3.1
 * @deprecated As of 3.2 (to be removed in 4.0), use
 *             {@link org.apache.commons.math3.ml.clustering.DBSCANClusterer}
 *             instead
 */
@Deprecated
