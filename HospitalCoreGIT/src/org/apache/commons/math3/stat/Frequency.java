 ...
 * </p>
 * <p>
 * NOTE: byte and short values will be implicitly converted to int values by the
 * compiler, thus there are no explicit overloaded methods for these primitive
 * types.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Float is not coerced to Double. Since they are not Comparable with each other
 * the user must do any necessary coercion. Float.NaN and Double.NaN are not
 * treated specially; they may occur in input and will occur in output if
 * appropriate. </b>
 * <p>
...
public class Frequency implements Serializable {
     ...
     *            the value to add.
     * @throws MathIllegalArgumentException
     *             if the table contains entries not comparable to Long
     */
     ...
     *            the value to add.
     * @throws MathIllegalArgumentException
     *             if the table contains entries not comparable to Char
     */
     ...
     * <p>
     * If added values are integral (i.e., integers, longs, Integers, or Longs),
     * they are converted to Longs when they are added, so the values of the map
     * entries returned by the Iterator will in this case be Longs.
     * </p>
     *
    ...
    /**
     * Returns the number of values equal to v. Returns 0 if the value is not
     * comparable.
     *
     * @param v
     *            the value to lookup.
	...
	// Get the max count first, so we avoid having to recreate the List each
	// time
    ...
    /**
     * Merge another Frequency object's counts into this instance. This
     * Frequency's counts will be incremented (or set when not already set) by
     * the counts represented by other.
     *
     * @param other
    ...
    /**
     * Merge a {@link Collection} of {@link Frequency} objects into this
     * instance. This Frequency's counts will be incremented (or set when not
     * already set) by the counts represented by each of the others.
     *
     * @param others
