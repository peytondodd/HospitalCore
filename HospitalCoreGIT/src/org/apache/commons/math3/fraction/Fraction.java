...
public class Fraction extends Number implements FieldElement<Fraction>, Comparable<Fraction>, Serializable {
	...
	// check for (almost) integer arguments, which should not go to
	// iterations.
     ...
     * @return true if two fractions are equal, false if object is {@code null},
     *         not an instance of {@link Fraction}, or not equal to this
     *         fraction instance.
     */
    @Override
	...
	if (d1 == 1) {
	    ...
	    return new Fraction(isAdd ? ArithmeticUtils.addAndCheck(uvp, upv) : ArithmeticUtils.subAndCheck(uvp, upv),
