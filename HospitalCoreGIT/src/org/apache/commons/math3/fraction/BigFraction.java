...
public class BigFraction extends Number implements FieldElement<BigFraction>, Comparable<BigFraction>, Serializable {
    ...
    /**
     * <p>
     * Create a {@link BigFraction} equivalent to the passed {@code BigInteger},
     * ie "num / 1".
     * </p>
     *
     * @param num
     ...
     * <p>
     * Create a {@link BigFraction} given the numerator and denominator as
     * simple {@code int}. The {@link BigFraction} is reduced to lowest terms.
     * </p>
     *
     * @param num
     *            the numerator.
     ...
     * <p>
     * Create a {@link BigFraction} given the numerator and denominator as
     * simple {@code long}. The {@link BigFraction} is reduced to lowest terms.
     * </p>
     *
     * @param num
     *            the numerator.
    ...
    /**
     * <p>
     * Adds the value of this fraction to the passed {@code long}, returning the
    ...
    /**
     * <p>
     * Multiply the value of this fraction by the passed {@code long}, returning
     * the result in reduced form.
     * </p>
     *
     * @param l
