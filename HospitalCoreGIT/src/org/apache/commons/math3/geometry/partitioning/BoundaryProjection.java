...
public class BoundaryProjection<S extends Space> {
     ...
     *            projected point
     * @param offset
     *            offset of the point with respect to the boundary it is
     *            projected on
     */
     ...
     * {@link #getOriginal() original point} is inside the region, and positive
     * otherwise.
     * </p>
     * <p>
     ...
     * </p>
     * 
     * @return offset of the point with respect to the boundary it is projected
     *         on
     */
