...
/**
 * Utility class checking if inside nodes can be found on the plus and minus
 * sides of an hyperplane.
 * 
 * @param <S>
 *            Type of the space.
 * @since 3.4
...
class InsideFinder<S extends Space> {
    ...
    /**
     * Search recursively for inside leaf nodes on each side of the given
     * hyperplane.
     * 
     * <p>
     * The algorithm used here is directly derived from the one described in
     * section III (<i>Binary Partitioning of a BSP Tree</i>) of the Bruce
     * Naylor, John Amanatides and William Thibault paper
	...
	case BOTH:
	    ...
	    break;
	default:
	    // the sub-hyperplane and the cut sub-hyperplane share the same
	    // hyperplane
