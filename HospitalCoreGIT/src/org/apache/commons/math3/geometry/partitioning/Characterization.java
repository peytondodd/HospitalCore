...
class Characterization<S extends Space> {
     ...
     * Simple constructor.
     * <p>
     * Characterization consists in splitting the specified sub-hyperplane into
     * several parts lying in inside and outside cells of the tree. The
     * principle is to compute characterization twice for each cut
     * sub-hyperplane in the tree, once on the plus node and once on the minus
     * node. The parts that have the same flag (inside/inside or
     * outside/outside) do not belong to the boundary while parts that have
     * different flags (inside/outside or outside/inside) do belong to the
     * boundary.
     * </p>
     * 
     * @param node
     ...
     * <p>
     * The filtering consist in splitting the specified sub-hyperplane into
     * several parts lying in inside and outside cells of the tree. The
     * principle is to call this method twice for each cut sub-hyperplane in the
     * tree, once on the plus node and once on the minus node. The parts that
     * have the same flag (inside/inside or outside/outside) do not belong to
     * the boundary while parts that have different flags (inside/outside or
     ...
     * 
     * @return parts of the cut sub-hyperplane known to touch outside cells (may
     *         be null or empty)
     */
     ...
     * <p>
     * Splitting nodes are internal nodes (i.e. they have a non-null cut
     * sub-hyperplane).
     * </p>
     * 
     ...
     * 
     * @return parts of the cut sub-hyperplane known to touch inside cells (may
     *         be null or empty)
     */
