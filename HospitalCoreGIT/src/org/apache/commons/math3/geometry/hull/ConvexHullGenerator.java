 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Convex_hull">Convex Hull
 *      (Wikipedia)</a>
 * @see <a href="http://mathworld.wolfram.com/ConvexHull.html">Convex Hull
 *      (MathWorld)</a>
 *
 * @since 3.3
 */
public interface ConvexHullGenerator<S extends Space, P extends Point<S>> {
     ...
     *             if generator fails to generate a convex hull for the given
     *             set of input points
     */
