...
/**
 * Class implementing Emo Welzl algorithm to find the smallest enclosing ball in
 * linear time.
 * <p>
 * The class implements the algorithm described in paper <a href=
 * "http://www.inf.ethz.ch/personal/emo/PublFiles/SmallEnclDisk_LNCS555_91.pdf">Smallest
 * Enclosing Disks (Balls and Ellipsoids)</a> by Emo Welzl, Lecture Notes in
 * Computer Science 555 (1991) 359-370. The pivoting improvement published in
 * the paper <a href=
 * "http://www.inf.ethz.ch/personal/gaertner/texts/own_work/esa99_final.pdf">Fast
 * and Robust Smallest Enclosing Balls</a>, by Bernd Gärtner and further
 * modified in paper <a
 * href=http://www.idt.mdh.se/kurser/ct3340/ht12/MINICONFERENCE/FinalPapers/ircse12_submission_30.pdf">
 * Efficient Computation of Smallest Enclosing Balls in Three Dimensions</a> by
 * Linus Källberg to avoid performing local copies of data have been included.
 * </p>
 * 
 * @param <S>
 *            Space type.
...
public class WelzlEncloser<S extends Space, P extends Point<S>> implements Encloser<S, P> {
	...
	// Emo Welzl algorithm with Bernd Gärtner and Linus Källberg
	// improvements
	...
	while (true) {
	    ...
	    // recurse search, restricted to the small subset containing support
	    // and farthest point
	    support.clear();
