...
public class Segment {
     ...
     * <p>
     * If the perpendicular extension from the point to the line does not cross
     * in the bounds of the line segment, the shortest distance to the two end
     * points will be returned.
     * </p>
     *
     * Algorithm adapted from: <a href=
	...
	// if point isn't on the line segment, just return the shortest distance
	// to the end points
	if (r < 0 || r > 1) {
