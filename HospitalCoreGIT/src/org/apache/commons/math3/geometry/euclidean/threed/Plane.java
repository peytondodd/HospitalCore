...
public class Plane implements Hyperplane<Euclidean3D>, Embedding<Euclidean3D, Euclidean2D> {
     ...
     *             {@link #Plane(Vector3D, Vector3D, double)}
     */
    @Deprecated
     ...
     *                if the points do not constitute a plane
     * @deprecated as of 3.3, replaced with
     *             {@link #Plane(Vector3D, Vector3D, Vector3D, double)}
     */
    @Deprecated
     ...
     * deep copy is used, none of the underlying object are shared.
     * </p>
     * 
     * @param plane
     *            plane to copy
     ...
     * <p>
     * The updated instance is completely independant of the original one. A
     * deep reset is used none of the underlying object is shared.
     * </p>
     * 
     * @param original
     *            plane to reset from
     ...
     * <p>
     * The point returned is the orthogonal projection of the 3D-space origin in
     * the plane.
     * </p>
     * 
     ...
     * {@code (x, y)} in-plane coordinates and {@code z} offset with respect to
     * the plane and is unaffected by the change will have {@code (y, x)}
     * in-plane coordinates and {@code -z} offset with respect to the new plane.
     * This means that the {@code u} and {@code v} vectors returned by the
     * {@link #getU} and {@link #getV} methods are exchanged, and the {@code w}
     * vector returned by the {@link #getNormal} method is reversed.
     * </p>
     */
     ...
     * 
     * @param point
     *            point of the space (must be a {@link Vector3D Vector3D}
     *            instance)
     * @return in-plane point (really a
     *         {@link org.apache.commons.math3.geometry.euclidean.twod.Vector2D
     *         Vector2D} instance)
     * @see #toSpace
     */
     ...
     * <p>
     * Planes are considered similar if they contain the same points. This does
     * not mean they are equal since they can have opposite normals.
     * </p>
     * 
     * @param plane
     ...
     * @return intersection point between between the line and the instance
     ...
     *         (really a {@link Line Line} instance)
     */
     ...
     * @param plane3
     *            third plane2
     * @return intersection point of three planes, null if some planes are
     *         parallel
     */
	...
	return new Vector3D((-a23 * d1 - (c1 * b3 - c3 * b1) * d2 - (c2 * b1 - c1 * b2) * d3) * r,
     ...
     * <p>
     * This method should be called only for parallel planes otherwise the
     * result is not meaningful.
     * </p>
     * <p>
     * The offset is 0 if both planes are the same, it is positive if the plane
     * is on the plus side of the instance and negative if it is on the minus
     * side, according to its natural orientation.
     * </p>
     * 
     * @param plane
     *            plane to check
     ...
     * <p>
     * The offset is 0 if the point is on the underlying hyperplane, it is
     * positive if the point is on one particular side of the hyperplane, and it
     * is negative if the point is on the other side, according to the
     * hyperplane natural orientation.
     * </p>
     * 
     * @param point
     *            point to check
