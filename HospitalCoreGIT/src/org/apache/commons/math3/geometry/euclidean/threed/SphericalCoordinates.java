...
/**
 * This class provides conversions related to
 ...
 * coordinates are related to Cartesian coordinates as follows:
 * </p>
 * <ul>
 ...
 * </ul>
 * <p>
 * r is the radius, &theta; is the azimuthal angle in the x-y plane and &Phi; is
 * the polar (co-latitude) angle. These conventions are <em>different</em> from
 * the conventions used in physics (and in particular in spherical harmonics)
 * where the meanings of &theta; and &Phi; are reversed.
 * </p>
 * <p>
 * This class provides conversion of coordinates and also of gradient and
 * Hessian between spherical and Cartesian coordinates.
 * </p>
 * 
 * @since 3.2
 */
public class SphericalCoordinates implements Serializable {
     ...
     * 
     * @param sGradient
     *            gradient with respect to spherical coordinates {df/dr,
     *            df/d&theta;, df/d&Phi;}
     * @return gradient with respect to Cartesian coordinates {df/dx, df/dy,
     *         df/dz}
     */
     ...
     * provided spherical Hessian, so the upper part may not be initialized.
     * However, we still do fill up the complete array we create, with
     * guaranteed symmetry.
     * </p>
     * 
     * @param sHessian
     ...
     *            d<sup>2</sup>f/drd&Phi;}, {d<sup>2</sup>f/drd&theta;,
     *            d<sup>2</sup>f/d&theta;<sup>2</sup>,
     *            d<sup>2</sup>f/d&theta;d&Phi;}, {d<sup>2</sup>f/drd&Phi;,
     ...
     *         d<sup>2</sup>f/dxdz}, {d<sup>2</sup>f/dxdy,
     *         d<sup>2</sup>f/dy<sup>2</sup>, d<sup>2</sup>f/dydz},
