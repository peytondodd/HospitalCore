 ...
 * 
 * <p>
 * Each oriented line is intrinsically associated with an abscissa which is a
 * coordinate on the line. The point at abscissa 0 is the orthogonal projection
 * of the origin on the line, another equivalent way to express this is to say
 * that it is the point of the line which is closest to the origin. Abscissa
 * increases in the line direction.
 * </p>
 * 
 * @since 3.0
 */
public class Line implements Embedding<Euclidean3D, Euclidean1D> {
     ...
     *             {@link #Line(Vector3D, Vector3D, double)}
     */
    @Deprecated
     ...
     * <p>
     * Lines are considered similar if they contain the same points. This does
     * not mean they are equal since they can have opposite directions.
     * </p>
     * 
     * @param line
