...
abstract class AbstractConvexHullGenerator2D implements ConvexHullGenerator2D {
     ...
     *            indicates if collinear points on the hull shall be added as
     *            hull vertices
     */
     ...
     * 
     * @return {@code true} if collinear points are added as hull vertices, or
     *         {@code false} if only extreme points are present.
     */
	...
	try {
	    ...
	    // the hull vertices may not form a convex hull if the tolerance
	    // value is to large
