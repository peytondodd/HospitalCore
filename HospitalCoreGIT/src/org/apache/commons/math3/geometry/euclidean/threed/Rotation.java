 ...
 * in this case the frame is fixed and the vector moves.
 * </p>
 * <p>
 ...
 * essentially be an application of the first approach.
 * </p>
 *
 * <p>
...
public class Rotation implements Serializable {
     ...
     * {@link #Rotation(Vector3D, double, RotationConvention) new Rotation(axis,
	...
	final double[][] m = new double[][] {
		{ MathArrays.linearCombination(u1.getX(), v1.getX(), u2.getX(), v2.getX(), u3.getX(), v3.getX()),
			...
			MathArrays.linearCombination(u1.getZ(), v1.getX(), u2.getZ(), v2.getX(), u3.getZ(),
				v3.getX()) },
     ...
     * new Rotation(order, RotationConvention.VECTOR_OPERATOR, alpha1, alpha2,
     * alpha3)}
     * </p>
     * 
     * @param order
     ...
     * <p>
     * Calling this method is equivalent to call
     * {@link #getAngles(RotationOrder, RotationConvention) getAngles(order,
