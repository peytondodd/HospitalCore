 ...
 * <p>
 * This class extracts the 2D outlines from {{@link PolygonsSet polyhedrons
 * sets} in a specified projection plane.
 * </p>
 * 
 * @since 3.0
 */
public class OutlineExtractor {
     ...
     * <p>
     * The neighbors are computed considering the array is a loop (i.e. point at
     * index (n-1) is before point at index 0)
     * </p>
     * 
     * @param loop
     *            points array
	...
	private void addContribution(final SubHyperplane<Euclidean3D> facet, final boolean reversed) {
		...
		for (Vector2D[] loop : vertices) {
			...
			final org.apache.commons.math3.geometry.euclidean.twod.Line line = new org.apache.commons.math3.geometry.euclidean.twod.Line(
				pPoint, cPoint, tolerance);
			...
			if (closed || (previous != 1)) {
			    ...
			    final org.apache.commons.math3.geometry.euclidean.twod.Line l = new org.apache.commons.math3.geometry.euclidean.twod.Line(
				    pPoint, angle, tolerance);
