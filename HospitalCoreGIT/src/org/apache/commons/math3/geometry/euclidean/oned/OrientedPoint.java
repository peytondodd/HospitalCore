...
public class OrientedPoint implements Hyperplane<Euclidean1D> {
     ...
     * @param direct
     *            if true, the plus side of the hyperplane is towards abscissas
     ...
     *             {@link #OrientedPoint(Vector1D, boolean, double)}
     */
    @Deprecated
     ...
     * 
     * @return a region containing the instance (really an {@link IntervalsSet
     ...
     * 
     * @return true if the plus side of the hyperplane is towards abscissae
     *         greater than hyperplane location
     */
