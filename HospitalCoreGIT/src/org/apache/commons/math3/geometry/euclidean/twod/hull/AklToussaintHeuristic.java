 ...
 * <p>
 * The heuristic is based on the idea of a convex quadrilateral, which is formed
 * by four points with the lowest and highest x / y coordinates. Any point that
 * lies inside this quadrilateral can not be part of the convex hull and can
 * thus be safely discarded before generating the convex hull itself.
 * <p>
...
public final class AklToussaintHeuristic {
    ...
    /**
     * Returns a point set that is reduced by all points for which it is safe to
     * assume that they are not part of the convex hull.
     *
     * @param points
    ...
    /**
     * Build the convex quadrilateral with the found corner points (with min/max
     * x/y coordinates).
     *
     * @param points
