...
public class Vector2D implements Vector<Euclidean2D> {
     ...
     * <p>
     * The cross product can be used to determine the location of a point with
     * regard to the line formed by (p1, p2) and is calculated as: \[ P = (x_2 -
     * x_1)(y_3 - y_1) - (y_2 - y_1)(x_3 - x_1) \] with \(p3 = (x_3, y_3)\)
     * being this instance.
     * <p>
     * If the result is 0, the points are collinear, i.e. lie on a single
     * straight line L; if it is positive, this point lies to the left,
     * otherwise to the right of the line formed by (p1, p2).
     *
     * @param p1
     ...
     * <code>p1.subtract(p2).getNorm()</code> except that no intermediate vector
     * is built
     * </p>
     * 
     * @param p1
     ...
     * @return true if two 2D vector objects are equal, false if object is null,
     *         not an instance of Vector2D, or not equal to this Vector2D
     *         instance
     *
     */
    @Override
