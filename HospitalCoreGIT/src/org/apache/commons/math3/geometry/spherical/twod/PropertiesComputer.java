...
class PropertiesComputer implements BSPTreeVisitor<Sphere2D> {
	...
	if ((Boolean) node.getAttribute()) {
	    ...
	    final SphericalPolygonsSet convex = new SphericalPolygonsSet(
		    node.pruneAroundConvexCell(Boolean.TRUE, Boolean.FALSE, null), tolerance);
	...
	// see Spherical Trigonometry: For the Use of Colleges and Schools by I.
	// Todhunter
	// article 99 in chapter VIII Area Of a Spherical Triangle. Spherical
	// Excess.
	// book available from project Gutenberg at
