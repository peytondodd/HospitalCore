...
public class Vertex {
    ...
    /**
     * Get the common circle bound with both the instance and another vertex, if
     * any.
     * <p>
     ...
     * @return circle bound with both the instance and another vertex, or null
     *         if the two vertices do not share a circle yet
     */
     ...
     * Set incoming edge.
     * <p>
     * The circle supporting the incoming edge is automatically bound with the
     * instance.
     * </p>
     * 
     * @param incoming
     ...
     * Set outgoing edge.
     * <p>
     * The circle supporting the outgoing edge is automatically bound with the
     * instance.
     * </p>
     * 
     * @param outgoing
