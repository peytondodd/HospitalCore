...
public class Edge {
     ...
     * <p>
     * The angle along the edge should normally be between 0 and
     * {@link #getLength()} in order to remain within edge limits. However,
     * there are no checks on the value of the angle, so user can rebuild the
     ...
     * Split the edge.
     * <p>
     * Once split, this edge is not referenced anymore by the vertices, it is
     * replaced by the two or three sub-edges and intermediate splitting
     ...
     * <p>
     * If the length of the sub-edge to add is smaller than the
     * {@link Circle#getTolerance()} tolerance of the support circle, it will be
     * ignored.
     * </p>
     * 
     * @param subStart
     ...
     * @return end vertex of the edge ({@code subEnd} if the edge was long
     *         enough and really added, {@code subStart} if the edge was too
     *         small and therefore ignored)
     */
