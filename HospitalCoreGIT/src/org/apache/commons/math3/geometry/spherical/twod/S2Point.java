 ...
 * <p>
 * We use the mathematical convention to use the azimuthal angle \( \theta \) in
 * the x-y plane as the first coordinate, and the polar angle \( \varphi \) as
 * the second coordinate (see
...
public class S2Point implements Point<Sphere2D> {
     ...
     *         object is null, not an instance of S2Point, or not equal to this
     *         S2Point instance
     *
     */
    @Override
