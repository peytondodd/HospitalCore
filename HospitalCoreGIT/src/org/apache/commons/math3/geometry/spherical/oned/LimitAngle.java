...
public class LimitAngle implements Hyperplane<Sphere1D> {
     ...
     * @param direct
     *            if true, the plus side of the hyperplane is towards angles
     *            greater than {@code location}
     * @param tolerance
     *            tolerance below which angles are considered identical
     */
     ...
     * 
     * @return true if the plus side of the hyperplane is towards angles greater
     *         than hyperplane location
     */
     ...
     * <p>
     * Get a limit angle with reversed orientation with respect to the instance.
     * A new object is built, the instance is untouched.
     * </p>
     * 
     * @return a new limit angle, with orientation opposite to the instance
     *         orientation
     */
     ...
     * <p>
     * Since this class represent zero dimension spaces which does not have
     * lower dimension sub-spaces, this method returns a dummy implementation of
     * a {@link org.apache.commons.math3.geometry.partitioning.SubHyperplane
     ...
     * 
     * @return a region containing the instance (really an {@link ArcsSet
     *         IntervalsSet} instance)
     */
