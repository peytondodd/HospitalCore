 ...
 * <a href="http://mathworld.wolfram.com/Sphere.html">Sphere</a> on MathWorld),
 * i.e. the 1-sphere is the one-dimensional closed curve defined in 2D as
...
public class Sphere1D implements Serializable, Space {
     ...
     * {@inheritDoc}
     * <p>
     * As the 1-dimension sphere does not have proper sub-spaces, this method
     * always throws a {@link NoSubSpaceException}
     * </p>
     * 
     * @return nothing
     ...
     * <p>
     * This exception is thrown when attempting to get the sub-space of a
