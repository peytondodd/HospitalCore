...
public class EvaluationRmsChecker implements ConvergenceChecker<Evaluation> {
    ...
    /**
     * Create a convergence checker for the RMS with the same relative and
     * absolute tolerance.
     *
     * <p>
     * Convenience constructor for when the relative and absolute tolerances are
     * the same. Same as {@code new EvaluationRmsChecker(tol, tol)}.
     *
     * @param tol
    ...
    /**
     * Create a convergence checker for the RMS with a relative and absolute
     * tolerance.
     *
     * <p>
     * The optimization has converged when the RMS of consecutive evaluations
     * are equal to within the given relative tolerance or absolute tolerance.
     *
     * @param relTol
