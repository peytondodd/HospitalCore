...
public class CurveFitter<T extends ParametricUnivariateFunction> {
    ...
    /**
     * Fit a curve. This method compute the coefficients of the curve that best
     * fit the sample of observed points previously given through calls to the
	...
	// Perform the fit.
	final PointVectorValuePair optimum = optimizer.optimize(new MaxEval(maxEval), model.getModelFunction(),
		model.getModelFunctionJacobian(), new Target(target), new Weight(weights),
