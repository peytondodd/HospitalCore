 ...
 * {@link AbstractCurveFitter curve fitting} algorithms.
 *
 * @since 3.3
 */
public class WeightedObservedPoints implements Serializable {
    ...
    /**
     * Adds a point to the sample. Calling this method is equivalent to calling
     * {@code add(1.0, x, y)}.
     *
     * @param x
     *            Abscissa of the point.
     * @param y
     *            Observed value at {@code x}. After fitting we should have
     *            {@code f(x)} as close as possible to this value.
     *
    ...
    /**
     * Gets a <em>snapshot</em> of the observed points. The list of stored
     * points is copied in order to ensure that modification of the returned
     * instance does not affect this container. Conversely, further modification
     * of this container (through the {@code add} or {@code clear} methods) will
