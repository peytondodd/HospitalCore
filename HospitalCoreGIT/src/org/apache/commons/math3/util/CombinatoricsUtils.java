...
public final class CombinatoricsUtils {
    ...
    /**
     * Returns a {@code double} representation of the
     * <a href="http://mathworld.wolfram.com/BinomialCoefficient.html"> Binomial
     * Coefficient</a>, "{@code n choose k}", the number of {@code k}-element
     * subsets that can be selected from an {@code n}-element set.
     * <p>
     ...
     * value of {@code n} for which all coefficients are less than
    ...
    /**
     * Returns the natural {@code log} of the
     * <a href="http://mathworld.wolfram.com/BinomialCoefficient.html"> Binomial
     * Coefficient</a>, "{@code n choose k}", the number of {@code k}-element
     * subsets that can be selected from an {@code n}-element set.
     * <p>
    ...
    /**
     * Returns n!. Shorthand for {@code n}
     * <a href="http://mathworld.wolfram.com/Factorial.html"> Factorial</a>, the
     * product of the numbers {@code 1,...,n}.
     * <p>
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li>{@code n >= 0} (otherwise {@code MathIllegalArgumentException} is
     * thrown)</li>
     * <li>The result is small enough to fit into a {@code long}. The largest
     * value of {@code n} for which {@code n!} does not exceed Long.MAX_VALUE}
     * is 20. If the computed value exceeds {@code Long.MAX_VALUE} an
     ...
     * {@code double}: The largest {@code n} for which {@code n!} does not
     * exceed {@code Double.MAX_VALUE} is 170. If the computed value exceeds
