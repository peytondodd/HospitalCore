 ...
 * conceptual structure. This utility will convert from indices in a
 * multidimensional structure to the corresponding index in a one-dimensional
 * array. For example, assuming that the ranges (in 3 dimensions) of indices are
 * 2, 4 and 3, the following correspondences, between 3-tuples indices and
 * unidimensional indices, will hold:
 * <ul>
...
public class MultidimensionalCounter implements Iterable<Integer> {
	 ...
	 *             if {@link #hasNext()} would have returned {@code false}.
	 */
	public Integer next() {
	    if (!hasNext()) {
	 ...
	 * @param dim
	 *            Dimension index.
	 * @return the count at the corresponding index for the current state of
	 *         the iterator.
	 * @throws IndexOutOfBoundsException
	 *             if {@code index} is not in the correct interval (as
	 *             defined by the length of the argument in the
     ...
     *             if {@code index} is not between {@code 0} and the value
     *             returned by {@link #getSize()} (excluded).
     */
     ...
     *             if the size of {@code c} does not match the size of the array
     *             given in the constructor.
     * @throws OutOfRangeException
     *             if a value of {@code c} is not in the range of the
     *             corresponding dimension, as defined in the
     *             {@link MultidimensionalCounter#MultidimensionalCounter(int...)
     *             constructor}.
     */
