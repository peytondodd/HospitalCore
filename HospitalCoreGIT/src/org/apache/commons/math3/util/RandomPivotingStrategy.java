...
public class RandomPivotingStrategy implements PivotingStrategyInterface, Serializable {
    ...
    /**
     * {@inheritDoc} A uniform random pivot selection between begin and end
     * indices
     * 
     * @return The index corresponding to a random uniformly selected value
     *         between first and the last indices of the array slice
