...
public final class ArithmeticUtils {
     ...
     *             integer.
     * @deprecated use
     *             {@link CombinatoricsUtils#binomialCoefficientDouble(int, int)}
     */
    @Deprecated
     ...
     *             integer.
     * @deprecated use
     *             {@link CombinatoricsUtils#binomialCoefficientLog(int, int)}
     */
    @Deprecated
     ...
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li>{@code n >= 0} (otherwise {@code IllegalArgumentException} is
     * thrown)</li>
     * <li>The result is small enough to fit into a {@code long}. The largest
