...
public final class MathUtils {
     ...
     * @return the value, within the interval {@code [0 |period|)}, that
	...
	if ((magnitude >= 0 && sign >= 0) || (magnitude < 0 && sign < 0)) { // Sign
									    // is
									    // OK.
	    return magnitude;
     ...
     *         same sign as the {@code sign} argument.
     * @throws MathArithmeticException
     *             if {@code magnitude == Short.MIN_VALUE} and
     *             {@code sign >= 0}.
     */
     ...
     *         same sign as the {@code sign} argument.
     * @throws MathArithmeticException
     *             if {@code magnitude == Integer.MIN_VALUE} and
     *             {@code sign >= 0}.
     */
     ...
     *             if {@code x} is not a finite real number.
     */
