...
public class Precision {
     ...
     *         y, eps)} &amp;&amp; x &lt; y</li>
     *         <li>> 0 if !{@link #equals(double, double, double) equals(x, y,
     *         eps)} &amp;&amp; x > y or either argument is NaN</li>
     *         </ul>
     */
     ...
     * error (inclusive). Returns {@code false} if either of the arguments is
     * NaN.
     *
     * @param x
     *            first value
     ...
     * defined by {@link #equals(float,float,int) equals(x, y, maxUlps)}.
     *
     * @param x
     *            first value
     * @param y
    ...
    /**
     * Returns true if the arguments are both NaN or they are equal as defined
     * by {@link #equals(double,double) equals(x, y, 1)}.
     *
     * @param x
     *            first value
     * @param y
	...
	try {
	    ...
	    // MATH-1089: negative values rounded to zero should result in
	    // negative zero
