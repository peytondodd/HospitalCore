...
public interface BaseUnivariateOptimizer<FUNC extends UnivariateFunction>
     ...
     *             if {@code min > max} or the endpoints do not satisfy the
     *             requirements specified by the optimizer.
     */
    UnivariatePointValuePair optimize(int maxEval, FUNC f, GoalType goalType, double min, double max);

    /**
     * Find an optimum in the given interval, start at startValue. An optimizer
     * may require that the interval brackets a single optimum.
     *
     * @param f
     *            Function to optimize.
     * @param goalType
