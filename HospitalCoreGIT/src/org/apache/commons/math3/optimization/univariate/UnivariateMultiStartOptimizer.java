...
public class UnivariateMultiStartOptimizer<FUNC extends UnivariateFunction> implements BaseUnivariateOptimizer<FUNC> {
     ...
     * {@link #optimize(int,UnivariateFunction,GoalType,double,double)
     * optimize}. The optimizer stores all the optima found during a set of
     * restarts. The
     * {@link #optimize(int,UnivariateFunction,GoalType,double,double) optimize}
     * method returns the best point only. This method returns all the points
     * found at the end of each starts, including the best one already returned
     * by the {@link #optimize(int,UnivariateFunction,GoalType,double,double)
     * optimize} method. <br/>
