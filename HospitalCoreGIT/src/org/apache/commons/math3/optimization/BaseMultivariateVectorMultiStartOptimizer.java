...
public class BaseMultivariateVectorMultiStartOptimizer<FUNC extends MultivariateVectorFunction>
     ...
     *            {@link #optimize(int,MultivariateVectorFunction,double[],double[],double[])
     *            optimize} will return the same solution as {@code optimizer}
     *            would.
     * @param generator
     ...
     * {@link #optimize(int,MultivariateVectorFunction,double[],double[],double[])
     * optimize} method did throw a {@link ConvergenceException}). This also
     * means that if the first element is not {@code null}, it is the best point
     * found across all starts.
     *
