 ...
 * smaller than another threshold for all vectors elements. <br/>
 ...
 * has been set (see {@link #SimpleVectorValueChecker(double,double,int) this
 * constructor}).
 *
...
public class SimpleVectorValueChecker extends AbstractConvergenceChecker<PointVectorValuePair> {
     ...
     * {@link #converged(int,PointVectorValuePair,PointVectorValuePair)} to
     * return {@code true}.
     */
    ...
    /**
     * Builds an instance with specified tolerance thresholds and iteration
     * count.
     *
     * In order to perform only relative checks, the absolute tolerance must be
     * set to a negative value. In order to perform only absolute checks, the
