 ...
 * The interval can possibly be infinite (in one or both directions). This base
 * class handles the boiler-plate methods associated to thresholds settings,
 * iterations and evaluations counting.
 *
 * @param <FUNC>
 ...
 * @since 3.0
 * @deprecated As of 3.1 since the {@link BaseAbstractMultivariateOptimizer base
 *             class} contains similar functionality.
 */
@Deprecated
public abstract class BaseAbstractMultivariateSimpleBoundsOptimizer<FUNC extends MultivariateFunction>
    ...
    /**
     * Simple constructor with default settings. The convergence checker is set
     * to a {@link org.apache.commons.math3.optimization.SimpleValueChecker}.
     *
