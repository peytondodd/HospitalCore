...
public class NelderMeadSimplex extends AbstractSimplex {
    ...
    /**
     * Build a Nelder-Mead simplex with default coefficients. The default
     * coefficients are 1.0 for rho, 2.0 for khi and 0.5 for both gamma and
     * sigma.
     *
     * @param n
     ...
     *            Dimension of the simplex.
     * @param sideLength
     *            Length of the sides of the default (hypercube) simplex. See
     ...
     *            may be negative but not zero. See
     */
