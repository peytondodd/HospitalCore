...
public abstract class BaseAbstractMultivariateVectorOptimizer<FUNC extends MultivariateVectorFunction>
     ...
     * a {@link SimpleVectorValueChecker}.
     * 
     * @deprecated See
     *             {@link SimpleVectorValueChecker#SimpleVectorValueChecker()}
     */
    @Deprecated
    ...
    /**
     * Gets the objective vector function. Note that this access bypasses the
     * evaluation counter.
     *
     ...
     *
     * @return the point/value pair giving the optimal value for the objective
     *         function.
     */
     ...
     * class. It will be called after the parsing step performed in the
     * {@link #optimize(int,MultivariateVectorFunction,OptimizationData[])
     ...
     *
     * @throws DimensionMismatchException
     *             if {@link #target} and {@link #weightMatrix} have
     *             inconsistent dimensions.
     */
