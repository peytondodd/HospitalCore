...
/**
 * Base class for implementing least squares optimizers. It handles the
 * boilerplate methods associated to thresholds settings, Jacobian and error
 * estimation. <br/>
 * This class constructs the Jacobian matrix of the function argument in method
 * {@link BaseAbstractMultivariateVectorOptimizer#optimize(int, org.apache.commons.math3.analysis.MultivariateVectorFunction,OptimizationData[])
 * optimize} and assumes that the rows of that matrix iterate on the model
 * functions while the columns iterate on the parameters; thus, the numbers of
 * rows is equal to the dimension of the
 * {@link org.apache.commons.math3.optimization.Target Target} while the number
 * of columns is equal to the dimension of the
...
public abstract class AbstractLeastSquaresOptimizer
    ...
    /**
     * Jacobian matrix of the weighted residuals. This matrix is in canonical
     * form just after the calls to {@link #updateJacobian()}, but may be
     * modified by the solver in the derived class (the
     * {@link LevenbergMarquardtOptimizer Levenberg-Marquardt optimizer} does
     * this).
     * 
     ...
     * 
     * @deprecated As of 3.1. Field to become "private" in 4.0. Please use
     *             {@link #setCost(double)}.
     */
    @Deprecated
    ...
    /**
     * Simple constructor with default settings. The convergence check is set to
     * a {@link org.apache.commons.math3.optimization.SimpleVectorValueChecker}.
     * 
     * @deprecated See
     *             {@link org.apache.commons.math3.optimization.SimpleValueChecker#SimpleValueChecker()}
     */
    @Deprecated
     ...
     * 
     * @throws DimensionMismatchException
     *             if the dimension does not match the problem dimension.
     * @throws org.apache.commons.math3.exception.TooManyEvaluationsException
     *             if the maximal number of evaluations is exceeded.
     * @deprecated As of 3.1. Please use {@link #computeResiduals(double[])},
     *             {@link #computeObjectiveValue(double[])},
     *             {@link #computeCost(double[])} and {@link #setCost(double)}
     *             instead.
     */
    @Deprecated
     ...
     * @deprecated As of 3.1. Please use
     *             {@link #computeCovariances(double[],double)} instead.
     */
    @Deprecated
     ...
     * <code>J<sup>T</sup>J</code> matrix, where {@code J} is the Jacobian
     * matrix. The {@code threshold} parameter is a way for the caller to
     * specify that the result of this computation should be considered
     * meaningless, and thus trigger an exception.
     *
     * @param threshold
     ...
     * <p>
     * See also
     * <a href="http://en.wikipedia.org/wiki/Least_squares">Wikipedia</a>, or
     * <a href=
     * "http://mathworld.wolfram.com/LeastSquaresFitting.html">MathWorld</a>,
     ...
     *             if the number of degrees of freedom is not positive, i.e. the
     *             number of measurements is less or equal to the number of
     *             parameters.
     * @deprecated as of version 3.1, {@link #computeSigma(double[],double)}
     *             should be used instead. It should be emphasized that
     *             {@code guessParametersErrors} and {@code computeSigma} are
     *             <em>not</em> strictly equivalent.
     */
    @Deprecated
     ...
     *            {@link #computeCovariances(double[],double)
     *            computeCovariances}).
     * @return an estimate of the standard deviation of the optimized parameters
     * @throws org.apache.commons.math3.linear.SingularMatrixException
     *             if the covariance matrix cannot be computed.
	...
	return optimizeInternal(maxEval, FunctionUtils.toMultivariateDifferentiableVectorFunction(f),
		new Target(target), new Weight(weights), new InitialGuess(startPoint));
    }

    /**
     * Optimize an objective function. Optimization is considered to be a
     * weighted least-squares minimization. The cost function to be minimized is
     ...
     *             if the maximal number of evaluations is exceeded.
     * @throws DimensionMismatchException
     *             if the target, and weight arguments have inconsistent
     *             dimensions.
     ...
     * @since 3.1
     * @deprecated As of 3.1. Override is necessary only until this class's
     *             generic argument is changed to
     *             {@code MultivariateDifferentiableVectorFunction}.
     */
    @Deprecated
	...
	// efficient than converting the value returned from
    ...
    /**
     * Computes the residuals. The residual is the difference between the
     * observed (target) values and the model (objective function) value. There
     * is one residual for each element of the vector-valued function.
     *
     * @param objectiveValue
     *            Value of the the objective function. This is the value
