...
public abstract class AbstractConvergenceChecker<PAIR> implements ConvergenceChecker<PAIR> {
     ...
     *             problem-dependent. As this class is intended for users who
     *             want to set their own convergence criterion instead of
     *             relying on an algorithm's default procedure, they should also
     *             set the thresholds appropriately (cf. MATH-798).
     */
    @Deprecated
