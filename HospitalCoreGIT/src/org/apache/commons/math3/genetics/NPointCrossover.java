...
public class NPointCrossover<T> implements CrossoverPolicy {
     ...
     *             if the number of {@code crossoverPoints} is not strictly
     *             positive
     */
    ...
    /**
     * Performs a N-point crossover. N random crossover points are selected and
     * are used to divide the parent chromosomes into segments. The segments are
     * copied in alternate order from the two parents to the corresponding child
     * chromosomes.
     *
     * Example (2-point crossover):
     * 
     ...
     *             iff one of the chromosomes is not an instance of
     ...
     *             if the number of crossoverPoints is too large for the actual
     *             chromosomes
     */
