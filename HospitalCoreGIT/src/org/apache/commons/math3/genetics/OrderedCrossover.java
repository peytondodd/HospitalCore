...
public class OrderedCrossover<T> implements CrossoverPolicy {
	...
	for (int i = 1; i <= length; i++) {
	    ...
	    // if the first child already contains the item in the second parent
	    // add it
	    ...
	    // if the second child already contains the item in the first parent
	    // add it
	...
	// rotate so that the original slice is in the same place as in the
	// parents.
