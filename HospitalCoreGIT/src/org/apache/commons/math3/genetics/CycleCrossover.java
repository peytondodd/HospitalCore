...
public class CycleCrossover<T> implements CrossoverPolicy {
     ...
     *
     * @param randomStart
     *            whether the start index shall be chosen randomly or be set to
     *            0
     */
     ...
     *
     * @return {@code true} if the starting index is chosen randomly,
     ...
     *             if the chromosomes are not an instance of
