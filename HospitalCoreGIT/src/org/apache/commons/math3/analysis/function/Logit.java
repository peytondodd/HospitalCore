...
/**
 * <a href="http://en.wikipedia.org/wiki/Logit"> Logit</a> function. It is the
 * inverse of the {@link Sigmoid sigmoid} function.
 *
 * @since 3.0
 */
public class Logit implements UnivariateDifferentiableFunction, DifferentiableUnivariateFunction {
    ...
    /**
     * Usual logit function, where the lower bound is 0 and the higher bound is
     * 1.
     */
    public Logit() {
	this(0, 1);
     ...
     * logit function, ordered as follows:
     * <ul>
     * <li>Lower bound</li>
     * <li>Higher bound</li>
     * </ul>
	 ...
	 * respect to each of the <em>parameters</em> (lower bound and higher
	 * bound).
	 *
	 * @param x
