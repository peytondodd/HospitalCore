...
public class Logistic implements UnivariateDifferentiableFunction, DifferentiableUnivariateFunction {
     ...
     *            +&infin;. If {@code b < 0}, value of the function for x going
     *            towards -&infin;.
     * @param m
     *            Abscissa of maximum growth.
     * @param b
     ...
     *            towards +&infin;.
     * @param n
     *            Parameter that affects near which asymptote the maximum growth
     *            occurs.
     ...
     * {@link Logistic#Logistic(double,double,double,double,double,double)
	 ...
	 * @param param
	 *            Values for {@code k}, {@code m}, {@code b}, {@code q},
	 *            {@code a} and {@code n}.
	 * @return the value of the function.
	 * @throws NullArgumentException
	 *             if {@code param} is {@code null}.
	 * @throws DimensionMismatchException
	 *             if the size of {@code param} is not 6.
	 * @throws NotStrictlyPositiveException
	 *             if {@code param[5] <= 0}.
	 */
	 ...
	 * respect to each of the <em>parameters</em>.
	 *
	 * @param x
