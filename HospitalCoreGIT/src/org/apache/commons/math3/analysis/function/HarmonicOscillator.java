...
/**
 * <a href="http://en.wikipedia.org/wiki/Harmonic_oscillator"> simple harmonic
 * oscillator</a> function.
 *
 * @since 3.0
 */
public class HarmonicOscillator implements UnivariateDifferentiableFunction, DifferentiableUnivariateFunction {
     ...
     * harmonic oscillator function, ordered as follows:
     * <ul>
     * <li>Amplitude</li>
	 ...
	 * respect to each of the <em>parameters</em> (amplitude, angular
	 * frequency and phase).
	 *
	 * @param x
