...
/**
 * <a href="http://en.wikipedia.org/wiki/Sigmoid_function"> Sigmoid</a>
 * function. It is the inverse of the {@link Logit logit} function. A more
 * flexible version, the generalised logistic, is implemented by the
 * {@link Logistic} class.
 *
 * @since 3.0
 */
public class Sigmoid implements UnivariateDifferentiableFunction, DifferentiableUnivariateFunction {
     ...
     * {@link Sigmoid#Sigmoid(double,double) sigmoid function}, ordered as
     * follows:
     * <ul>
	 ...
	 *             if the size of {@code param} is not 2.
	 */
	 ...
	 * respect to each of the <em>parameters</em> (lower asymptote and
	 * higher asymptote).
	 *
	 * @param x
