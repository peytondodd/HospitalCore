 ...
 * interface. The data to be interpolated is assumed to be periodic. Thus values
 * that are outside of the range can be passed to the interpolation function:
...
public class UnivariatePeriodicInterpolator implements UnivariateInterpolator {
     ...
     *            Period.
     * @param extend
     *            Number of points to be appended at the beginning and end of
     *            the sample arrays in order to avoid interpolation failure at
     *            the (periodic) boundaries of the orginal interval. The value
     *            is the number of sample points which the original
     *            {@code interpolator} needs on each side of the interpolated
     *            point.
     */
    ...
    /**
     * Builds an interpolator. Uses {@link #DEFAULT_EXTEND} as the number of
     * extension points on each side of the original abscissae range.
     *
     * @param interpolator
     *            Interpolator.
     * @param period
     ...
     *             if the number of extension points is larger than the size of
     *             {@code xval}.
     */
