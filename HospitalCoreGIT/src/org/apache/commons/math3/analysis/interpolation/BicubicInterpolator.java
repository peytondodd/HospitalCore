 ...
 * differences (using the 2-points symmetric formulae). Since their values are
 * undefined at the borders of the provided interpolation ranges, the
 * interpolated values will be wrong at the edges of the patch. The
 * {@code interpolate} method will return a function that overrides
 * {@link BicubicInterpolatingFunction#isValidPoint(double,double)} to indicate
 * points where the interpolation will be inaccurate.
 * </p>
 *
 * @since 3.4
 */
