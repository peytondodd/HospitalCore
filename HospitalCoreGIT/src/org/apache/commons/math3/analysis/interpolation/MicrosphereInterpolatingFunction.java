...
public class MicrosphereInterpolatingFunction implements MultivariateFunction {
    ...
    /**
     * Internal accounting data for the interpolation algorithm. Each element of
     * the list corresponds to one surface element of the microsphere.
     */
    private final List<MicrosphereSurfaceElement> microsphere;
    /**
     * Exponent used in the power law that computes the weights of the sample
     * data.
     */
    ...
    /**
     * Class for storing the accounting data needed to perform the microsphere
     * projection.
     */
    ...
    /**
     * @param xval
     *            Arguments for the interpolation points. {@code xval[i][0]} is
     *            the first component of interpolation point {@code i},
     *            {@code xval[i][1]} is the second component, and so on until
     *            {@code xval[i][d-1]}, the last component of that interpolation
     *            point (where {@code dimension} is thus the dimension of the
     *            sampled space).
     * @param yval
     ...
     *             if the lengths of {@code yval} and {@code xval} (equal to
     *             {@code n}, the number of interpolation points) do not match,
     *             or the the arrays {@code xval[0]} ... {@code xval[n]}, have
     *             lengths different from {@code dimension}.
	...
	// Compute contribution of each sample points to the microsphere
