...
public class InterpolatingMicrosphere {
    ...
    /**
     * Create an unitialiazed sphere. Sub-classes are responsible for calling
     * the {@code add(double[]) add} method in order to initialize all the
     * sphere's facets.
     *
     * @param dimension
     *            Dimension of the data space.
     * @param size
     *            Number of surface elements of the sphere.
     * @param maxDarkFraction
     *            Maximum fraction of the facets that can be dark. If the
     *            fraction of "non-illuminated" facets is larger, no estimation
     *            of the value will be performed, and the {@code background}
     *            value will be returned instead.
     * @param darkThreshold
     *            Value of the illumination below which a facet is considered
     *            dark.
     * @param background
     *            Value returned when the {@code maxDarkFraction} threshold is
     *            exceeded.
     * @throws NotStrictlyPositiveException
     *             if {@code dimension <= 0} or {@code size <= 0}.
     * @throws NotPositiveException
     *             if {@code darkThreshold < 0}.
     * @throws OutOfRangeException
     *             if {@code maxDarkFraction} does not belong to the interval
     *             {@code [0, 1]}.
     */
     ...
     *             if the size of the generated vectors does not match the
     *             dimension set in the constructor.
     * @throws NotStrictlyPositiveException
     *             if {@code dimension <= 0} or {@code size <= 0}.
     * @throws NotPositiveException
     *             if {@code darkThreshold < 0}.
    ...
    /**
     * Estimate the value at the requested location. This microsphere is placed
     * at the given {@code point}, contribution of the given
     * {@code samplePoints} to each sphere facet is computed (illumination) and
     * the interpolation is performed (integration of the illumination).
     *
     * @param point
     *            Interpolation point.
     * @param samplePoints
     ...
     * @param sampleValues
     *            Sampling data values at the corresponding
     *            {@code samplePoints}.
     * @param exponent
     *            Exponent used in the power law that computes the weights
     *            (distance dimming factor) of the sample data.
     * @param noInterpolationTolerance
     *            When the distance between the {@code point} and one of the
     *            {@code samplePoints} is less than this value, no interpolation
     *            will be performed, and the value of the sample will just be
     *            returned.
    ...
    /**
     * Replace {@code i}-th facet of the microsphere. Method for initializing
     * the microsphere facets.
     *
     * @param normal
     *            Facet's normal vector.
     * @param copy
     *            Whether to copy the given array.
     * @throws DimensionMismatchException
     *             if the length of {@code n} does not match the space
     *             dimension.
     * @throws MaxCountExceededException
     *             if the method has been called more times than the size of the
     *             sphere.
     */
     ...
     *            Vector whose origin is at the interpolation point and tail is
	...
	/**
	 * @param n
	 *            Normal vector characterizing a surface element of the
	 *            microsphere. No copy is made.
	 */
	Facet(double[] n) {
	    normal = n;
	}
