 ...
 * integrate functions with few function evaluations. A Legendre-Gauss
 * integrator using an n-points quadrature formula can integrate 2n-1 degree
 * polynomials exactly.
 * </p>
 * <p>
...
public class LegendreGaussIntegrator extends BaseAbstractUnivariateIntegrator {
	...
	case 5:
	    ...
	    break;
	default:
	    throw new MathIllegalArgumentException(LocalizedFormats.N_POINTS_GAUSS_LEGENDRE_INTEGRATOR_NOT_SUPPORTED, n,
		    2, 5);
	}
	...
	while (true) {
	    ...
	    final double limit = FastMath.max(getAbsoluteAccuracy(),
