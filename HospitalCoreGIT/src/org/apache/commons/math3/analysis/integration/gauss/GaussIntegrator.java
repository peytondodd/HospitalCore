 ...
 * {@link #integrate(UnivariateFunction) integrating} a weighted function.
 *
 * @since 3.1
 */
public class GaussIntegrator {
    ...
    /**
     * Creates an integrator from the given pair of points (first element of the
     * pair) and weights (second element of the pair.
     *
    ...
    /**
     * Returns an estimate of the integral of {@code f(x) * w(x)}, where
     * {@code w} is a weight function that depends on the actual flavor of the
     * Gauss integration scheme. The algorithm uses the points and associated
     * weights, as passed to the {@link #GaussIntegrator(double[],double[])
     * constructor}.
     *
     * @param f
    ...
    /**
     * Gets the integration point at the given index. The index must be in the
     * valid range but no check is performed.
     * 
     * @param index
    ...
    /**
     * Gets the weight of the integration point at the given index. The index
     * must be in the valid range but no check is performed.
     * 
     * @param index
     *            index of the integration point
     * @return the weight.
