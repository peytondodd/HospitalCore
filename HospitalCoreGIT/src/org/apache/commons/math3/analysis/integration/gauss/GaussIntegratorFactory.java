...
public class GaussIntegratorFactory {
     ...
     * \(e^{-x^2}f(x)\) where \(f(x)\) is the function passed to the
     * {@link SymmetricGaussIntegrator#integrate(org.apache.commons.math3.analysis.UnivariateFunction)
     * integrate} method.
     *
     * @param numberOfPoints
    ...
    /**
     * Performs a change of variable so that the integration can be performed on
     * an arbitrary interval {@code [a, b]}. It is assumed that the natural
     * interval is {@code [-1, 1]}.
     *
     * @param rule
