 ...
 *
 * @param <T>
 *            Type of the number used to represent the points and weights of the
 *            quadrature rules.
 *
 * @since 3.1
 */
public abstract class BaseRuleFactory<T extends Number> {
    ...
    /**
     * Gets a rule. Synchronization ensures that rules will be computed and
     * added to the cache at most once. The returned rule is a reference into
     * the cache.
     *
     * @param numberOfPoints
