...
public abstract class BaseAbstractUnivariateIntegrator implements UnivariateIntegrator {
     ...
     * The iteration count.
     * 
     * @deprecated as of 3.6, this field has been replaced with
     *             {@link #incrementCount()}
     */
    @Deprecated
     ...
     * accuracy can't be achieved due to large values or short mantissa length.
     * If this should be the primary criterion for convergence rather then a
     * safety measure, set the absolute accuracy to a ridiculously small value,
     * like {@link org.apache.commons.math3.util.Precision#SAFE_MIN
     * Precision.SAFE_MIN}.</li>
     * <li>absolute accuracy: The default is usually chosen so that results in
     * the interval -10..-0.1 and +0.1..+10 can be found with a reasonable
     * accuracy. If the expected absolute value of your results is of much
     * smaller magnitude, set this to a smaller value.</li>
     * <li>minimum number of iterations: minimal iteration is needed to avoid
     * false early convergence, e.g. the sample points happen to be zeroes of
     * the function. Users can use the default value or choose one that they see
     * as appropriate.</li>
     * <li>maximum number of iterations: usually a high iteration count
     * indicates convergence problems. However, the "reasonable value" varies
     * widely for different algorithms. Users are advised to use the default
     * value supplied by the algorithm.</li>
     * </ul>
     *
     ...
     *                if minimal number of iterations is not strictly positive
     * @exception NumberIsTooSmallException
     *                if maximal number of iterations is lesser than or equal to
     ...
     *                if the number of iterations exceeds the allowed maximum
     *                number
     */
    ...
    /**
     * Prepare for computation. Subclasses must call this method if they
