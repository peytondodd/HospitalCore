 ...
 * In this implementation, the lower and upper bounds of the natural interval of
 * integration are -1 and 1, respectively. The Legendre polynomials are
 * evaluated using the recurrence relation presented in
