...
/**
 * Implements the <em>Illinois</em> method for root-finding (approximating a
 * zero of a univariate real function). It is a modified
 ...
 * Furthermore, this implementation of the <em>Illinois</em> method should not
 * suffer from the same implementation issues as the <em>Regula Falsi</em>
 * method, which may fail to convergence in certain cases.
 * </p>
 *
 * <p>
 * The <em>Illinois</em> method assumes that the function is continuous, but not
 * necessarily smooth.
 * </p>
 *
 * <p>
