 ...
 * {@link IllinoisSolver <em>Illinois</em>} methods is based on the following
 * article: M. Dowell and P. Jarratt, <em>A modified regula falsi method for
 * computing the root of an equation</em>, BIT Numerical Mathematics, volume 11,
 * number 2, pages 168-174, Springer, 1971.
 * </p>
 *
 * <p>
 * Implementation of the {@link PegasusSolver <em>Pegasus</em>} method is based
 * on the following article: M. Dowell and P. Jarratt, <em>The "Pegasus" method
 * for computing the root of an equation</em>, BIT Numerical Mathematics, volume
 * 12, number 4, pages 503-508, Springer, 1972.
 * </p>
 *
 * <p>
 * The {@link SecantSolver <em>Secant</em>} method is <em>not</em> a bracketing
 * method, so it is not implemented here. It has a separate implementation.
 * </p>
 *
 * @since 3.0
 */
public abstract class BaseSecantSolver extends AbstractUnivariateSolver
	...
	while (true) {
	    ...
	    if (f1 * fx < 0) {
		// The value of x1 has switched to the other bound, thus
		// inverting
		// the interval.
		x0 = x1;
		f0 = f1;
	...
	/**
	 * The {@link RegulaFalsiSolver <em>Regula Falsi</em>} or <em>False
	 * Position</em> method.
	 */
	REGULA_FALSI,
