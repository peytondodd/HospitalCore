 ...
 * for finding zeros of real univariate functions. The function should be
 * continuous but not necessarily smooth. The {@code solve} method returns a
 * zero {@code x} of the function {@code f} in the given interval {@code [a, b]}
 * to within a tolerance {@code 2 eps abs(x) + t} where {@code eps} is the
 * relative accuracy and {@code t} is the absolute accuracy.
 * <p>
...
public class BrentSolver extends AbstractUnivariateSolver {
    ...
    /**
     * Search for a zero inside the provided interval. This implementation is
     * based on the algorithm described at page 58 of the book <blockquote>
     * <b>Algorithms for Minimization Without Derivatives</b>, <it>Richard P.
     * Brent</it>, Dover 0-486-41998-3 </blockquote>
     *
     * @param lo
