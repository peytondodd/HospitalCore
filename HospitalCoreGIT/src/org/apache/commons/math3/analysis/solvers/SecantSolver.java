...
/**
 * Implements the <em>Secant</em> method for root-finding (approximating a zero
 * of a univariate real function). The solution that is maintained is not
 ...
 *
 * <p>
 * Note that since release 3.0 this class implements the actual <em>Secant</em>
 * algorithm, and not a modified one. As such, the 3.0 version is not backwards
 * compatible with previous versions. To use an algorithm similar to the pre-3.0
 * releases, use the {@link IllinoisSolver <em>Illinois</em>} algorithm or the
