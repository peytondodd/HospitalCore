...
public class PolynomialFunctionLagrangeForm implements UnivariateFunction {
     ...
     * @throws DimensionMismatchException
     *             if {@code x} and {@code y} have different lengths.
     * @throws org.apache.commons.math3.exception.NonMonotonicSequenceException
     *             if {@code x} is not sorted in strictly increasing order.
     * @throws NumberIsTooSmallException
     *             if the size of {@code x} is less than 2.
     */
     ...
     * caution and only when it is necessary.
     * </p>
     *
     ...
     * data. It takes O(n^2) time. Note that this computation can be
     * ill-conditioned: Use with caution and only when it is necessary.
     */
    ...
    /**
     * Check that the interpolation arrays are valid. The arrays features
     * checked by this method are that both arrays have the same length and this
     ...
     *             if the number of points is less than 2.
     * @throws org.apache.commons.math3.exception.NonMonotonicSequenceException
     *             if {@code x} is not sorted in strictly increasing order and
