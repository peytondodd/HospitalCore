...
public class FunctionUtils {
     ...
     *             {@link #compose(UnivariateDifferentiableFunction...)}
     */
    @Deprecated
     ...
     * @return a function that computes the sum of the functions.
     * @deprecated as of 3.1 replaced by
     *             {@link #add(UnivariateDifferentiableFunction...)}
     */
    @Deprecated
     ...
     * @return a function that computes the product of the functions.
     * @deprecated as of 3.1 replaced by
     *             {@link #multiply(UnivariateDifferentiableFunction...)}
     */
    @Deprecated
     ...
     *             if the lower bound {@code min} is greater than, or equal to
    ...
    /**
     * Convert a {@link UnivariateDifferentiableFunction} into a
     ...
     *             {@link DifferentiableUnivariateFunction} interface itself is
     *             deprecated
     */
    @Deprecated
    ...
    /**
     * Convert a {@link DifferentiableUnivariateFunction} into a
     * {@link UnivariateDifferentiableFunction}.
     * <p>
     * Note that the converted function is able to handle
     * {@link DerivativeStructure} up to order one. If the function is called
     * with higher order, a {@link NumberIsTooLargeException} is thrown.
     * </p>
     * 
     * @param f
     *            function to convert
    ...
    /**
     * Convert a {@link MultivariateDifferentiableFunction} into a
     * {@link DifferentiableMultivariateFunction}.
     *
     * @param f
     *            function to convert
     * @return converted function
     * @deprecated this conversion method is temporary in version 3.1, as the
     *             {@link DifferentiableMultivariateFunction} interface itself
     *             is deprecated
     */
    @Deprecated
    ...
    /**
     * Convert a {@link DifferentiableMultivariateFunction} into a
     * {@link MultivariateDifferentiableFunction}.
     * <p>
     * Note that the converted function is able to handle
     * {@link DerivativeStructure} elements that all have the same number of
     * free parameters and order, and with order at most 1. If the function is
     * called with inconsistent numbers of free parameters or higher order, a
     * {@link DimensionMismatchException} or a {@link NumberIsTooLargeException}
     * will be thrown.
     * </p>
     * 
     * @param f
     ...
     * @return converted function
     * @deprecated this conversion method is temporary in version 3.1, as the
     *             {@link DifferentiableMultivariateVectorFunction} interface
