 ...
 * <p>
 * This interface represents a simple function which computes both the value and
 * the first derivative of a mathematical function. The derivative is computed
...
public interface UnivariateDifferentiableFunction extends UnivariateFunction {
     ...
     * <p>
     * {@link UnivariateDifferentiableFunction} classes compute both the value
     ...
     *                if t is inconsistent with the function's free parameters
     *                or order
     */
