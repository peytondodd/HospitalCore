...
/**
 * Extension of {@link UnivariateMatrixFunction} representing a univariate
...
public interface UnivariateDifferentiableMatrixFunction extends UnivariateMatrixFunction {
     ...
     *                if {@code x} does not satisfy the function's constraints
     *                (argument out of bound, or unsupported derivative order
     *                for example)
     */
