 ...
 * parameters; thus, the numbers of rows is equal to the dimension of the
 * underlying function vector value and the number of columns is equal to the
 * number of free parameters of the underlying function.
 * </p>
 * 
 * @since 3.1
 */
