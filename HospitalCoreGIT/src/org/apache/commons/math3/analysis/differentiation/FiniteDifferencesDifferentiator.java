...
public class FiniteDifferencesDifferentiator implements UnivariateFunctionDifferentiator,
    ...
    /**
     * Build a differentiator with number of points and step size when
     * independent variable is unbounded.
     * <p>
     * Beware that wrong settings for the finite differences differentiator can
     * lead to highly unstable and inaccurate results, especially for high
     * derivation orders. Using very small step sizes is often a <em>bad</em>
     * idea.
     * </p>
     * 
     * @param nbPoints
    ...
    /**
     * Build a differentiator with number of points and step size when
     * independent variable is bounded.
     * <p>
     ...
     * constraint holds even near the boundaries. This means the sample will not
     * be centered anymore in these cases. At an extreme case, computing
     * derivatives exactly at the lower bound will lead the sample to be
     ...
     *            step size (gap between each point)
     * @param tLower
     *            lower bound for independent variable (may be
     *            {@code Double.NEGATIVE_INFINITY} if there are no lower bounds)
     * @param tUpper
     *            upper bound for independent variable (may be
     *            {@code Double.POSITIVE_INFINITY} if there are no upper bounds)
     * @exception NotPositiveException
     *                if {@code stepsize <= 0} (note that
     *                {@link NotPositiveException} extends
     *                {@link NumberIsTooSmallException})
     ...
     * @exception NumberIsTooLargeException
     *                if the requested derivation order is larger or equal to
     ...
     * value function will throw a {@link NumberIsTooLargeException} if the
     * requested derivation order is larger or equal to the number of points.
     * </p>
     */
	...
	return new UnivariateDifferentiableFunction() {
		...
		// check we can achieve the requested derivation order with the
		// sample
