 ...
 * <p>
 * This class plays a similar role to {@link DerivativeStructure}, with a focus
 * on efficiency when dealing with large number of independent variables and
 * most computation depend only on a few of them, and when only first derivative
 * is desired. When these conditions are met, this class should be much faster
 * than {@link DerivativeStructure} and use less memory.
 * </p>
 *
 * @since 3.3
 */
public class SparseGradient implements RealFieldElement<SparseGradient>, Serializable {
    ...
    /**
     * Stored derivative, each key representing a different independent
     * variable.
     */
     ...
     * @param derivatives
     *            derivatives map, a deep copy will be performed, so the map
     *            given here will remain safe from changes in the new instance,
     *            may be null to create an empty derivatives map, i.e. a
     *            constant value
     */
     ...
     * {@link #add(SparseGradient)} method should be used.
     * </p>
     * 
     * @param a
     *            instance to add
	...
	final SparseGradient out = new SparseGradient(FastMath.scalb(value, n),
     ...
     * @param f1
     *            first derivative of the function at the current point (i.e.
     *            f'({@link #getValue()}))
     * @return f(this)
     */
	...
	// recompute an accurate value, taking care of cancellations
	out.value = MathArrays.linearCombination(a1.value, b1.value, a2.value, b2.value, a3.value, b3.value, a4.value,
		b4.value);
    ...
    /** {@inheritDoc} */
    public SparseGradient linearCombination(final double a1, final SparseGradient b1, final double a2,
	    final SparseGradient b2, final double a3, final SparseGradient b3, final double a4,
	    final SparseGradient b4) {
     ...
     * <p>
     * Sparse gradients are considered equal if they have the same value and the
     * same derivatives.
     * </p>
     * 
     * @param other
