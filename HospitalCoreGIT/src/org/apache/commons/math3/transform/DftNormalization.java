...
public enum DftNormalization {
    /**
     * Should be passed to the constructor of {@link FastFourierTransformer} to
     * use the <em>standard</em> normalization convention. This normalization
    ...
    /**
     * Should be passed to the constructor of {@link FastFourierTransformer} to
     * use the <em>unitary</em> normalization convention. This normalization
     * convention is defined as follows
     * <ul>
     * <li>forward transform: y<sub>n</sub> = (1 / &radic;N)
     * &sum;<sub>k=0</sub><sup>N-1</sup> x<sub>k</sub> exp(-2&pi;i n k /
     * N),</li>
