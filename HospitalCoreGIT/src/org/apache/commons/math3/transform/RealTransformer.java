 ...
 * does not implement this interface since it produces
 * {@link org.apache.commons.math3.complex.Complex} results instead of real
 * ones.
 *
 * @since 2.0
 */
public interface RealTransformer {
     ...
     *             if the array cannot be transformed with the given type (this
     *             may be for example due to array size, which is constrained in
     *             some transforms)
     */
     ...
     * @throws MathIllegalArgumentException
     *             if the sample cannot be transformed with the given type (this
     *             may be for example due to sample size, which is constrained
     *             in some transforms)
     */
