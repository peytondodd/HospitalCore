 ...
 * reference, see S. Winograd, <i>On computing the discrete Fourier
 * transform</i>, Mathematics of Computation, 32 (1978), 175 - 199.
 *
...
public class FastFourierTransformer implements Serializable {
     ...
     * @param type
     *            the type of transform (forward, inverse) which resulted in the
     *            specified data
     */
	...
	default:
	    /*
	     * This should never occur in normal conditions. However this clause
	     * has been added as a safeguard if other types of normalizations
	     * are ever implemented, and the corresponding test is forgotten in
	     * the present switch.
	     */
     ...
     * <ul>
     * <li>{@code dataRI[0][i]} is the real part of the {@code i}-th data
     * point,</li>
     ...
     *
     * @param dataRI
     *            the two dimensional array of real and imaginary parts of the
     *            data
     * @param normalization
     ...
     *             if the number of rows of the specified array is not two, or
     ...
     * @throws MathIllegalArgumentException
     *             if the number of sample points {@code n} is not a power of
     *             two
     */
     ...
     * implementation in any number of dimensions with O(N&times;log(N))
     * complexity with N = n<sub>1</sub> &times; n<sub>2</sub>
     * &times;n<sub>3</sub> &times; ... &times; n<sub>d</sub>, where
     * n<sub>k</sub> is the number of elements in dimension k, and d is the
