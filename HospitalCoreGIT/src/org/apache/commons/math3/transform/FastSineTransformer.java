 ...
 * which are specified by the parameter {@link DstNormalization}. <strong>It
 * should be noted that regardless to the convention, the first element of the
 * dataset to be transformed must be zero.</strong>
 * <p>
 ...
 * transform requires the length of the data to be a power of two. Besides, it
 * implicitly assumes that the sampled function is odd. In particular, the first
 * element of the data set must be 0, which is enforced in
...
public class FastSineTransformer implements RealTransformer, Serializable {
     ...
     *             if the length of the data array is not a power of two, or the
     *             first element of the data array is not zero
     */
