...
public class FastHadamardTransformer implements RealTransformer, Serializable {
     ...
     * <li><b>y</b> is the output vector (Fast Hadamard transform of
     * <b>x</b>),</li>
     ...
     * M[n][N])</em></li>
     * <li>Place the input vector {@code x[N]} in the first column of the matrix
     * {@code hadm}.</li>
     * <li>The entries of the submatrix {@code D_top} are calculated as follows
     * <ul>
     * <li>{@code D_top} goes from entry {@code [0][1]} to
     * {@code [N / 2 - 1][n + 1]},</li>
     * <li>the columns of {@code D_top} are the pairwise mutually exclusive sums
     ...
     * {@code [N][n + 1]},</li>
     * <li>the columns of {@code D_bottom} are the pairwise differences of the
     * previous column.</li>
     * </ul>
     * </li>
     ...
     * {@code hadm}.</li>
     * <li><em>Algorithm from <a href=
     * "http://www.archive.chipcenter.com/dsp/DSP000517F1.html">chipcenter</a>.</em></li>
     * </ol>
     * <h3>Visually</h3>
     ...
     * <th>0</th>
     * <td>x<sub>0</sub></td>
     * <td colspan="5" rowspan="5" align="center" valign="middle">&uarr;<br/>
