 ...
 * "http://http://en.wikipedia.org/wiki/Empirical_distribution_function">
 ...
 *
 * <p>
 * The implementation uses what amounts to the <a href=
 ...
 *
 * <p>
 * EmpiricalDistribution implements the {@link RealDistribution} interface as
 * follows. Given x within the range of values in the dataset, let B be the bin
 * containing x and let K be the within-bin kernel for B. Let P(B-) be the sum
 * of the probabilities of the bins below B and let K(B) be the mass of B under
 * K (i.e., the integral of the kernel density over B). Then set P(X < x) =
 * P(B-) + P(B) * K(x) / K(B) where K(x) is the kernel distribution evaluated at
 * x. This results in a cdf that matches the grouped frequency distribution at
 * the bin endpoints and interpolates within bins using within-bin kernels.
 * </p>
 *
...
public class EmpiricalDistribution extends AbstractRealDistribution {
     ...
     * the provided {@link RandomGenerator} as the source of random data.
     *
     * @param binCount
     *            number of bins. Must be strictly positive.
     * @param generator
     *            random data generator (may be null, resulting in default JDK
     *            generator)
     * @throws NotStrictlyPositiveException
     *             if {@code binCount <= 0}.
     * @since 3.0
    ...
    /**
     * Creates a new EmpiricalDistribution with the specified bin count using
     * the provided {@link RandomDataImpl} instance as the source of random
     * data.
     *
     * @param binCount
     *            number of bins
     ...
     *             {@link #EmpiricalDistribution(int,RandomGenerator)} instead.
     */
    @Deprecated
     ...
     * @since 3.0
     * @deprecated As of 3.1. Please use
     *             {@link #EmpiricalDistribution(RandomGenerator)} instead.
     */
    @Deprecated
    ...
    /**
     * Private constructor to allow lazy initialisation of the RNG contained in
     * the {@link #randomData} instance variable.
     *
     * @param binCount
     *            number of bins. Must be strictly positive.
     * @param randomData
     ...
     *
     * <p>
     * The input file <i>must</i> be an ASCII text file containing one valid
     * numeric entry per line.
     * </p>
     *
     * @param url
     ...
     *
     * <p>
     * Note: In versions 1.0-2.0 of commons-math, this method incorrectly
     * returned the array of probability generator upper bounds now returned by
     * {@link #getGeneratorUpperBounds()}.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns a fresh copy of the array of upper bounds of the subintervals of
     * [0,1] used in generating data from the empirical distribution.
     ...
     *
     * <p>
     * In versions 1.0-2.0 of commons-math, this array was (incorrectly)
     * returned by {@link #getUpperBounds()}.
     * </p>
     *
     * @since 2.1
     * @return array of upper bounds of subintervals used in data generation
     * @throws NullPointerException
     *             unless a {@code load} method has been called beforehand.
     */
     ...
     * <li>Compute K(B) = the mass of B with respect to the within-bin kernel
     * (i.e., the integral of the kernel density over B).</li>
     ...
     * <ol>
     * <li>Find the bin B that x belongs to.</li>
     * <li>Compute P(B) = the mass of B and P(B-) = the combined mass of the
     * bins below B.</li>
     * <li>Compute K(B) = the probability mass of B with respect to the
     * within-bin kernel and K(B-) = the kernel distribution evaluated at the
     * lower endpoint of B</li>
     * <li>Return P(B-) + P(B) * [K(x) - K(B-)] / K(B) where K(x) is the
     * within-bin kernel distribution function evaluated at x.</li>
     * </ol>
     ...
     * <li>Let K be the within-bin kernel distribution for bin i.</br>
     * Let K(B) be the mass of B under K. <br/>
     * Let K(B-) be K evaluated at the lower endpoint of B (the combined mass of
     * the bins below B under K).<br/>
     ...
     * @param i
     *            index of the bin
     * @return the difference in the within-bin kernel cdf between the upper and
     *         lower endpoints of bin i
     */
	...
	if (bStats.getN() == 1 || bStats.getVariance() == 0) {
	    ...
	    return new NormalDistribution(randomData.getRandomGenerator(), bStats.getMean(),
