...
public class RandomDataGenerator implements RandomData, Serializable {
    ...
    /**
     * Construct a RandomDataGenerator, using a default random generator as the
     ...
     * {@link RandomGenerator} as the source of (non-secure) random data.
     *
     * @param rand
	...
	return new PoissonDistribution(getRandomGenerator(), mean, PoissonDistribution.DEFAULT_EPSILON,
     ...
     * MathArrays.shuffle} in order to create a random shuffle of the set of
     * natural numbers {@code { 0, 1, ..., n - 1 }}.
     *
     * @throws NumberIsTooLargeException
     *             if {@code k > n}.
     * @throws NotStrictlyPositiveException
     ...
     * nextPermutation(c.size(), k)} in order to sample the collection.
     */
     ...
     * </p>
     *
     * @return the SecureRandom used to generate secure random data, wrapped in
     *         a {@link RandomGenerator}.
     */
