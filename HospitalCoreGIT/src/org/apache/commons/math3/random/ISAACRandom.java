...
/**
 * <a href="http://burtleburtle.net/bob/rand/isaacafa.html"> ISAAC: a fast
 * cryptographic pseudo-random number generator</a> <br/>
 * ISAAC (Indirection, Shift, Accumulate, Add, and Count) generates 32-bit
 * random numbers. ISAAC has been designed to be cryptographically secure and is
 * inspired by RC4. Cycles are guaranteed to be at least 2<sup>40</sup> values
 * long, and they are 2<sup>8295</sup> values long on average. The results are
...
public class ISAACRandom extends BitsStreamGenerator implements Serializable {
     ...
     * The instance is initialized using a combination of the current time and
     * system hash code of the instance as the seed.
     */
    public ISAACRandom() {
     ...
     *
     * @param seed
     *            Initial seed. If {@code null}, the seed will be related to the
     *            current time.
     */
