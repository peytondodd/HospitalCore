...
/**
 * <p>
 * This class provides a stable normalized random generator. It samples from a
 * stable distribution with location parameter 0 and scale 1.
 * </p>
 *
 * <p>
 * The implementation uses the Chambers-Mallows-Stuck method as described in
 * <i>Handbook of computational statistics: concepts and methods</i> by James E.
 * Gentle, Wolfgang H&auml;rdle, Yuichi Mori.
 * </p>
 *
 * @since 3.0
 */
public class StableRandomGenerator implements NormalizedRandomGenerator {
     ...
     *             if {@code alpha <= 0} or {@code alpha > 2} or
     *             {@code beta < -1} or {@code beta > 1}
     */
	...
	if (beta == 0d) {
		...
		x = 2d / FastMath.PI * (betaPhi * FastMath.tan(phi)
