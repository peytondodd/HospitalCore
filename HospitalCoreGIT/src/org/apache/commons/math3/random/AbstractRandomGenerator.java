 ...
 * <p>
 * All data generation methods are based on {@code code nextDouble()}. Concrete
...
public abstract class AbstractRandomGenerator implements RandomGenerator {
     ...
     * activation. The value {@code Double.NaN} signals that there is no cached
     ...
     * {@link #nextGaussian}. Implementations that do not override the default
     * implementation of {@code nextGaussian} should call this method in the
    ...
    /** {@inheritDoc} */
    public void setSeed(int[] seed) {
	// the following number is the largest prime that fits in 32 bits (it is
	// 2^32 - 5)
     ...
     * {@code long} seed. Sequences of values generated starting with the same
     ...
     * 2<font size="-1"><sup>32</sup></font> possible {@code int} values should
     ...
     * from this random number generator's sequence. All
     * 2<font size="-1"><sup>64</sup></font> possible {@code long} values should
     * be produced with (approximately) equal probability.
     * <p>
     * The default implementation returns
     * 
