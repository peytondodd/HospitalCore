...
/**
 * Any {@link RandomGenerator} implementation can be thread-safe if it is used
 * through an instance of this class. This is achieved by enclosing calls to the
 * methods of the actual generator inside the overridden {@code synchronized}
...
public class SynchronizedRandomGenerator implements RandomGenerator {
     ...
     *
     * @param rng
     *            Generator whose methods will be called through their
     *            corresponding overridden synchronized version. To ensure
     *            thread-safety, the wrapped generator <em>must</em> not be used
     *            directly.
     */
