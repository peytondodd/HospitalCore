 ...
 * {@link RandomGenerator} instance to generate non-secure data and a
 * {@link java.security.SecureRandom} instance to provide data for the
 * <code>nextSecureXxx</code> methods. If no <code>RandomGenerator</code> is
 * provided in the constructor, the default is to use a {@link Well19937c}
 * generator. To plug in a different implementation, either implement
 * <code>RandomGenerator</code> directly or extend
 ...
 * <strong>one</strong> <code>RandomDataGenerator</code> instance
 * repeatedly.</li>
 ...
 * <li>When a new <code>RandomDataGenerator</code> is created, the underlying
 * random number generators are <strong>not</strong> initialized. If you do not
 ...
 * <li>This implementation is not synchronized. The underlying
 * <code>RandomGenerator</code> or <code>SecureRandom</code> instances are not
 * protected by synchronization and are not guaranteed to be thread-safe.
 * Therefore, if an instance of this class is concurrently utilized by multiple
 * threads, it is the responsibility of client code to synchronize access to
 * seeding and data generation methods.</li>
 * </ul>
 * </p>
 * 
...
public class RandomDataImpl implements RandomData, Serializable {
     ...
     * {@link org.apache.commons.math3.distribution.BetaDistribution Beta
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.BinomialDistribution
     * Binomial Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.CauchyDistribution Cauchy
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.ChiSquaredDistribution
     * ChiSquare Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
     * @param df
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.FDistribution F
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.HypergeometricDistribution
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.PascalDistribution Pascal
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(IntegerDistribution) inversion} to generate
     * random values.
     *
     ...
     *             if the probability of success is not in the range
     *             {@code [0, 1]}.
     */
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.TDistribution T
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.WeibullDistribution Weibull
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(RealDistribution) inversion} to generate
     * random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link org.apache.commons.math3.distribution.ZipfDistribution Zipf
     * Distribution}. This implementation uses
     * {@link #nextInversionDeviate(IntegerDistribution) inversion} to generate
     * random values.
     *
