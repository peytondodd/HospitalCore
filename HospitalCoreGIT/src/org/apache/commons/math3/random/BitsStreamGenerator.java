...
public abstract class BitsStreamGenerator implements RandomGenerator, Serializable {
     ...
     *
     * <p>
     * The array is filled with bytes extracted from random integers. This
     * implies that the number of random bytes generated may be larger than the
     * length of the byte array.
     * </p>
     *
     * @param bytes
     *            Array in which to put the generated bytes. Cannot be
     *            {@code null}.
     */
     ...
     *            {@code null}.
     * @param start
     *            Index at which to start inserting the generated bytes.
     * @param len
