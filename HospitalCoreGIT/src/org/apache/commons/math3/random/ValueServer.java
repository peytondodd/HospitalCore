...
public class ValueServer {
    ...
    /**
     * Construct a ValueServer instance using a RandomDataImpl as its source of
     * random data.
     *
     * @param randomData
    ...
    /**
     * Construct a ValueServer instance using a RandomGenerator as its source of
     * random data.
     *
     * @since 3.1
     * @param generator
	...
	case CONSTANT_MODE:
	    return mu;
	default:
	    throw new MathIllegalStateException(LocalizedFormats.UNKNOWN_MODE, mode, "DIGEST_MODE", DIGEST_MODE,
		    "REPLAY_MODE", REPLAY_MODE, "UNIFORM_MODE", UNIFORM_MODE, "EXPONENTIAL_MODE", EXPONENTIAL_MODE,
    ...
    /**
     * Returns the data generation mode. See {@link ValueServer the class
     * javadoc} for description of the valid values of this property.
     *
    ...
    /**
     * Sets the {@link #getValuesFileURL() values file URL} using a string URL
     * representation.
     *
     * @param url
     ...
     *
     * <p>
     * The values file <i>must</i> be an ASCII text file containing one valid
    ...
    /**
     * Returns the {@link EmpiricalDistribution} used when operating in
     * {@value #DIGEST_MODE}.
     *
    ...
    /**
     * Returns the mean used when operating in {@link #GAUSSIAN_MODE},
     * {@link #EXPONENTIAL_MODE} or {@link #UNIFORM_MODE}. When operating in
     * {@link #CONSTANT_MODE}, this is the constant value always returned.
     * Calling {@link #computeDistribution()} sets this value to the overall
     * mean of the values in the {@link #getValuesFileURL() values file}.
     *
    ...
    /**
     * Sets the {@link #getMu() mean} used in data generation. Note that calling
     * this method after {@link #computeDistribution()} has been called will
     * have no effect on data generated in {@link #DIGEST_MODE}.
     *
     * @param mu
     *            new Mean value.
     */
     ...
     * {@link #GAUSSIAN_MODE}. Calling {@link #computeDistribution()} sets this
     * value to the overall standard deviation of the values in the
     * {@link #getValuesFileURL() values file}. This property has no effect when
     * the data generation mode is not {@link #GAUSSIAN_MODE}.
     *
    ...
    /**
     * Sets the {@link #getSigma() standard deviation} used in
     * {@link #GAUSSIAN_MODE}.
     *
     * @param sigma
     ...
     *
     * @param seed
     *            Value with which to reseed the {@link RandomDataImpl} used to
