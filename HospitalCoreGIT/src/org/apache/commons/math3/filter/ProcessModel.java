...
public interface ProcessModel {
     ...
     * {@link KalmanFilter} every prediction step, so implementations of this
     * interface may return a modified process noise depending on the current
     * iteration step.
     *
     ...
     * <p>
     * <b>Note:</b> if the return value is zero, the Kalman filter will
     * initialize the state estimation with a zero vector.
     *
     ...
     * <p>
     * <b>Note:</b> if the return value is zero, the Kalman filter will
     * initialize the error covariance with the process noise matrix.
     *
