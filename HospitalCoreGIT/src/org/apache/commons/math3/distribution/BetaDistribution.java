...
public class BetaDistribution extends AbstractRealDistribution {
     ...
     * parameters.". Communications of the ACM, 21, 317â€“322, 1978.
     * </p>
     */
    @Override
	 ...
	 * @param alpha
	 *            distribution first shape parameter
	 * @param beta
	 ...
	 *            random generator to use
	 * @param a0
	 *            distribution first shape parameter (&alpha;)
	 * @param a
	 *            min(&alpha;, &beta;) where &alpha;, &beta; are the two
	 *            distribution shape parameters
	 * @param b
	 *            max(&alpha;, &beta;) where &alpha;, &beta; are the two
	 *            distribution shape parameters
	 * @return sampled value
	 */
