...
public class TriangularDistribution extends AbstractRealDistribution {
     ...
     *
     * <p>
     * For this distribution, the returned value is not really meaningful, since
     * exact formulas are implemented for the computation of the
     ...
     *
     * For lower limit {@code a}, upper limit {@code b}, and mode {@code c}, the
     * variance is {@code (a^2 + b^2 + c^2 - a * b - a * c - b * c) / 18}.
     */
