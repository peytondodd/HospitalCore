...
public interface RealDistribution {
     ...
     * derivative of the {@link #cumulativeProbability(double) CDF}. If the
     ...
     *         certain cases in {@link TDistribution}) or {@code Double.NaN} if
     *         it is not defined
     */
     ...
     * connected, i.e. whether all values between the lower and upper bound of
