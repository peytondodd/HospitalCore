 ...
 * @see <a href=
 *      "http://mathworld.wolfram.com/MultivariateNormalDistribution.html">
...
public class MultivariateNormalDistribution extends AbstractMultivariateRealDistribution {
     ...
     * The number of dimensions is equal to the length of the mean vector and to
     * the number of rows and columns of the covariance matrix. It is frequently
     * written as "p" in formulae.
     * <p>
     ...
     *             if the arrays length are inconsistent.
     * @throws SingularMatrixException
     *             if the eigenvalue decomposition cannot be performed on the
    ...
    /**
     * Computes the term used in the exponent (see definition of the
     * distribution).
     *
     * @param values
