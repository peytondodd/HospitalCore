 ...
 *
 * <p>
 * <strong>Parameters:</strong> {@code X} is log-normally distributed if its
 * natural logarithm {@code log(X)} is normally distributed. The probability
 * distribution function of {@code X} is given by (for {@code x > 0})
 * </p>
 * <p>
 ...
 * <li>{@code s} is the <em>shape</em> parameter: this is the standard deviation
 * of the normally distributed natural logarithm of this distribution.
 * </ul>
 *
...
public class LogNormalDistribution extends AbstractRealDistribution {
     ...
     * of the {@link NormalDistribution normally distributed} natural logarithm
     * of the log-normal distribution are equal to zero and one respectively. In
     * other words, the scale of the returned distribution is {@code 0}, while
     * its shape is {@code 1}.
     * <p>
     ...
     * {@inheritDoc}
     *
     * For scale {@code m}, and shape {@code s} of this distribution, the PDF is
     * given by
     * <ul>
     ...
     * {@inheritDoc}
     *
     * For scale {@code m}, and shape {@code s} of this distribution, the CDF is
     * given by
     * <ul>
     * <li>{@code 0} if {@code x <= 0},</li>
     ...
     *
     * @deprecated See
     *             {@link RealDistribution#cumulativeProbability(double,double)}
     */
    @Override
    @Deprecated
