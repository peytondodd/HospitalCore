 ...
 *
 * <p>
 * <strong>Parameters:</strong> The probability distribution function of
 * {@code X} is given by (for {@code x >= k}):
 * 
 * <pre>
 * α * k ^ α / x ^ (α + 1)
 * </pre>
 * <p>
 * <ul>
 * <li>{@code k} is the <em>scale</em> parameter: this is the minimum possible
 * value of {@code X},</li>
 * <li>{@code α} is the <em>shape</em> parameter: this is the Pareto index</li>
 * </ul>
 *
 * @see <a href="http://en.wikipedia.org/wiki/Pareto_distribution"> Pareto
 *      distribution (Wikipedia)</a>
 * @see <a href="http://mathworld.wolfram.com/ParetoDistribution.html"> Pareto
...
public class ParetoDistribution extends AbstractRealDistribution {
    ...
    /**
     * Create a Pareto distribution with a scale of {@code 1} and a shape of
     * {@code 1}.
     */
    ...
    /**
     * Create a Pareto distribution using the specified scale, shape and inverse
     * cumulative distribution accuracy.
     * <p>
     * <b>Note:</b> this constructor will implicitly create an instance of
     * {@link Well19937c} as random generator to be used for sampling only (see
     * {@link #sample()} and {@link #sample(int)}). In case no sampling is
     ...
     * {@inheritDoc}
     * <p>
     * For scale {@code k}, and shape {@code α} of this distribution, the PDF is
     * given by
     * <ul>
     ...
     * {@inheritDoc}
     * <p>
     * For scale {@code k}, and shape {@code α} of this distribution, the CDF is
     * given by
     * <ul>
     * <li>{@code 0} if {@code x < k},</li>
