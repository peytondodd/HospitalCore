 ...
 *      (Wikipedia)</a>
 * @see <a href=
 *      "http://mathworld.wolfram.com/F-Distribution.html">F-distribution
 *      (MathWorld)</a>
 */
public class FDistribution extends AbstractRealDistribution {
    ...
    /**
     * Creates an F distribution using the given degrees of freedom and inverse
	...
	return nhalf * logn + nhalf * logx - logx + mhalf * logm - nhalf * lognxm - mhalf * lognxm
