 ...
 *
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Hypergeometric_distribution">Hypergeometric
 *      distribution (Wikipedia)</a>
 * @see <a href=
 *      "http://mathworld.wolfram.com/HypergeometricDistribution.html">Hypergeometric
...
public class HypergeometricDistribution extends AbstractIntegerDistribution {
	...
	if (x < domain[0] || x > domain[1]) {
	    ...
	    double p2 = SaddlePointExpansion.logBinomialProbability(sampleSize - x, populationSize - numberOfSuccesses,
		    p, q);
