...
public class PoissonDistribution extends AbstractIntegerDistribution {
     ...
     * {@link Gamma#regularizedGammaP(double, double, double, int)} or continued
     * fraction approximation of
     ...
     *            Poisson mean.
     * @param maxIterations
     *            Maximum number of iterations for cumulative probabilities.
     * @since 2.1
     */
     ...
     * approximation. The {@code N(mean, sqrt(mean))} distribution is used to
     * approximate the Poisson distribution. The computation uses
     ...
     * <a href="http://mathaa.epfl.ch/cours/PMMI2001/interactive/rng7.htm">
     * here</a>. The Poisson process (and hence value returned) is bounded by
     * 1000 * mean.</li>
     * <li>For large means, uses the rejection algorithm described in
     * <blockquote> Devroye, Luc. (1981).<i>The Computer Generation of Poisson
     * Random Variables</i><br>
