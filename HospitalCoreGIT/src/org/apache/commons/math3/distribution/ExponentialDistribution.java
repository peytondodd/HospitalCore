 ...
 *
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Exponential_distribution">Exponential
 *      distribution (Wikipedia)</a>
 * @see <a href=
 *      "http://mathworld.wolfram.com/ExponentialDistribution.html">Exponential
...
public class ExponentialDistribution extends AbstractRealDistribution {
     ...
     * q_i -> 1 as i -> +inf, so the higher i, the closer to one we get (the
	...
	/**
	 * ArithmeticUtils provides factorials up to 20, so let's use that limit
	 * together with Precision.EPSILON to generate the following code (a
	 * priori, we know that there will be 16 elements, but it is better to
	 * not hardcode it).
	 */
