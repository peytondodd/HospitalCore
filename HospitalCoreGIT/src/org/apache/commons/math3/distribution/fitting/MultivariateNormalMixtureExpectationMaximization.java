 ...
 *
 * This implementation is pure original code based on <a href=
 ...
 * Maya R. Gupta, Department of Electrical Engineering, University of
 * Washington, Seattle, WA 98195. It was verified using external tools like
 * <a href="http://cran.r-project.org/web/packages/mixtools/index.html">CRAN
 * Mixtools</a> (see the JUnit test cases) but it is <strong>not</strong> based
 * on Mixtools code at all. The discussion of the origin of this class can be
 * seen in the comments of the
 * <a href="https://issues.apache.org/jira/browse/MATH-817">MATH-817</a> JIRA
 * issue.
 * 
 * @since 3.2
 */
public class MultivariateNormalMixtureExpectationMaximization {
     ...
     *            Model containing initial values of weights and multivariate
     *            normals
     * @param maxIterations
     *            Maximum iterations allowed for fit
     * @param threshold
     *            Convergence threshold computed as difference in logLikelihoods
     *            between successive iterations
     * @throws SingularMatrixException
     *             if any component's covariance matrix is singular during
     *             fitting
     * @throws NotStrictlyPositiveException
     *             if numComponents is less than one or threshold is less than
     *             Double.MIN_VALUE
     * @throws DimensionMismatchException
     *             if initialMixture mean vector and data number of columns are
     *             not equal
     */
     ...
     *             if {@code numComponents} is greater than the number of data
     *             rows.
     * @throws NumberIsTooSmallException
