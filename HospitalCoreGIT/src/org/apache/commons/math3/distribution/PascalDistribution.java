 ...
 * This is the convention adopted in e.g. <a href=
 * "http://mathworld.wolfram.com/NegativeBinomialDistribution.html">MathWorld</a>,
 * but <em>not</em> in <a href=
 * "http://en.wikipedia.org/wiki/Negative_binomial_distribution">Wikipedia</a>.
 * </p>
 * <p>
 * For a random variable {@code X} whose values are distributed according to
 * this distribution, the probability mass function is given by<br/>
 ...
 * {@code P(X <= k) = I(p, r, k + 1)}, where I is the regularized incomplete
 * Beta function.
 * </p>
 *
...
public class PascalDistribution extends AbstractIntegerDistribution {
    ...
    /**
     * The value of {@code log(p)}, where {@code p} is the probability of
     * success, stored for faster computation.
     */
    private final double logProbabilityOfSuccess;
    /**
     * The value of {@code log(1-p)}, where {@code p} is the probability of
     * success, stored for faster computation.
     */
	...
	if (x < 0) {
	    ...
	    ret = CombinatoricsUtils.binomialCoefficientLog(x + numberOfSuccesses - 1, numberOfSuccesses - 1)
		    + logProbabilityOfSuccess * numberOfSuccesses + log1mProbabilityOfSuccess * x;
	}
	return ret;
    }
