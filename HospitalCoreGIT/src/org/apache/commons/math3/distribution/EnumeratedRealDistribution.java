...
public class EnumeratedRealDistribution extends AbstractRealDistribution {
    ...
    /**
     * {@link EnumeratedDistribution} (using the {@link Double} wrapper) used to
     * generate the pmf.
     */
    protected final EnumeratedDistribution<Double> innerDistribution;

    /**
     * Create a discrete real-valued distribution using the given probability
    ...
    /**
     * Create a discrete real-valued distribution using the given random number
     * generator and probability mass function enumeration.
     *
     * @param rng
    ...
    public EnumeratedRealDistribution(final RandomGenerator rng, final double[] singletons,
	    final double[] probabilities) throws DimensionMismatchException, NotPositiveException,
    ...
    /**
     * Create a discrete real-valued distribution from the input data. Values
     * are assigned mass based on their frequency.
     *
     * @param rng
    ...
    /**
     * Create a discrete real-valued distribution from the input data. Values
     * are assigned mass based on their frequency. For example, [0,1,1,2] as
     * input creates a distribution with values 0, 1 and 2 having probability
     * masses 0.25, 0.5 and 0.25 respectively,
     *
     * @param data
     *            input dataset
     * @since 3.6
    ...
    /**
     * Create the list of Pairs representing the distribution from singletons
     * and probabilities.
     *
     * @param singletons
     *            values
