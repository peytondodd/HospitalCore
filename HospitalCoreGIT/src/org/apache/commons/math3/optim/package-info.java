 ...
 * maximize} a scalar function, called the
 ...
 * (analytically or numerically). Algorithms that use this knowledge are defined
 * in the {@link org.apache.commons.math3.optim.nonlinear.scalar.gradient}
 * package. The algorithms that do not need this additional information are
 * located in the
 * {@link org.apache.commons.math3.optim.nonlinear.scalar.noderiv} package.
 * </p>
 *
 * <p>
 ...
 * {@link org.apache.commons.math3.optim.nonlinear.vector} package. <br/>
 ...
 * <br/>
 * The
 * {@link org.apache.commons.math3.optim.nonlinear.vector.jacobian.AbstractLeastSquaresOptimizer
 ...
 * <em>&chi;<sup>2</sup></em>) between model and observations. <br/>
 ...
 *
 * <p>
 * For each of the optimizer types, there is a special implementation that wraps
 * an optimizer instance and provides a "multi-start" feature: it calls the
 * underlying optimizer several times with different starting points and returns
 * the best optimum found, or all optima if so desired. This could be useful to
 * avoid being trapped in a local extremum.
 * </p>
 */
