...
/**
 * Base class for implementing optimizers for multivariate vector differentiable
 * functions. It contains boiler-plate code for dealing with Jacobian
 * evaluation. It assumes that the rows of the Jacobian matrix iterate on the
 * model functions while the columns iterate on the parameters; thus, the
 * numbers of rows is equal to the dimension of the {@link Target} while the
