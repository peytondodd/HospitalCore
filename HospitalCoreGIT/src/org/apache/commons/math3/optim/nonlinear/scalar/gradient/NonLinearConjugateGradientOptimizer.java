 ...
 * This class supports both the Fletcher-Reeves and the Polak-Ribière update
...
public class NonLinearConjugateGradientOptimizer extends GradientMultivariateOptimizer {
     ...
     * the start point is close enough of the optimum whether the Polak-Ribière
     * formula may not converge in rare cases. On the other hand, the
     * Polak-Ribière formula is often faster when it does converge.
     ...
     *            of {@link Formula#FLETCHER_REEVES} or
     ...
     *            brackets the optimum in order to perform the line search.
     *
	...
	this(updateFormula, checker, relativeTolerance, absoluteTolerance, initialBracketingRange,
	...
	this(updateFormula, checker, lineSearchSolver.getRelativeAccuracy(), lineSearchSolver.getAbsoluteAccuracy(),
		lineSearchSolver.getAbsoluteAccuracy(), preconditioner);
    }
