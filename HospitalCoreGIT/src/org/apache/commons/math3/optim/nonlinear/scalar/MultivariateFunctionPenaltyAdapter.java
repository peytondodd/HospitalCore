 ...
 * SimplexOptimizer}. A better solution is to use an optimizer that directly
 * supports simple bounds like
 ...
 * BOBYQAOptimizer}. One caveat of this poor-man's solution is that if start
 * point or start simplex is completely outside of the allowed range, only the
 * penalty function is used, and the optimizer may converge without ever
 * entering the range.
 * </p>
 *
