...
public abstract class MultivariateVectorOptimizer extends BaseMultivariateOptimizer<PointVectorValuePair> {
    ...
    /**
     * Computes the objective function value. This method <em>must</em> be
     * called by subclasses to enforce the evaluation counter limit.
     *
     * @param params
     ...
     *            BaseMultivariateOptimizer}, this method will register the
     *            following data:
     *            <ul>
     *            <li>{@link Target}</li>
     *            <li>{@link Weight}</li>
