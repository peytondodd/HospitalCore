 ...
 * BOBYQAOptimizer}. One caveat of this poor-man's solution is that behavior
 * near the bounds may be numerically unstable as bounds are mapped from
 * infinite values. Another caveat is that convergence values are evaluated by
 * the optimizer with respect to unbounded variables, so there will be scales
