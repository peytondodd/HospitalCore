...
/**
 * Special implementation of the {@link UnivariateOptimizer} interface adding
 * multi-start features to an existing optimizer. <br/>
...
public class MultiStartUnivariateOptimizer extends UnivariateOptimizer {
     ...
     *            {@code optimize} methods will return the same solution as
     ...
     *             if {@link #optimize(OptimizationData[]) optimize} has not
     *             been called.
     */
     ...
     *             {@link MaxEval} or {@link SearchInterval}.
     */
    @Override
