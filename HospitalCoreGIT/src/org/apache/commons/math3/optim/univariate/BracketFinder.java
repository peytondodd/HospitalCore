...
/**
 * Provide an interval that brackets a local optimum of a function. This code is
 * based on a Python implementation (from <em>SciPy</em>, module
 * {@code optimize.py} v0.5).
 *
 * @since 2.2
 */
public class BracketFinder {
     ...
     *            Maximum number of evaluations allowed for finding a bracketing
     *            interval.
     */
