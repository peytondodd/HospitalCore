...
/**
 * Simple optimization constraints: lower and upper bounds. The valid range of
 * the parameters is an interval that can be infinite (in one or both
 * directions). <br/>
 * Immutable class.
 *
 * @since 3.1
...
public class SimpleBounds implements OptimizationData {
     ...
     * @return a new instance suitable for passing to an optimizer that requires
