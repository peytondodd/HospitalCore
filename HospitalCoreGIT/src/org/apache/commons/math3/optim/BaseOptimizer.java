...
/**
 * Base class for implementing optimizers. It contains the boiler-plate code for
 * counting the number of evaluations of the objective function and the number
 * of iterations of the algorithm, and storing the convergence checker. <em>It
...
public abstract class BaseOptimizer<PAIR> {
    ...
    /**
     * Gets the number of evaluations of the objective function. The number of
    ...
    /**
     * Gets the number of iterations performed by the algorithm. The number
     * iterations corresponds to the last call to the {@code optimize} method.
     * It is 0 if the method has not been called yet.
     *
     * @return the number of evaluations of the objective function.
     */
     ...
     * {@link #parseOptimizationData(OptimizationData[])} if they need to
     * register their own options; but then, they <em>must</em> also call
     * {@code super.parseOptimizationData(optData)} within that method.
     *
     * @param optData
     *            Optimization data. This method will register the following
     *            data:
     *            <ul>
     *            <li>{@link MaxEval}</li>
     *            <li>{@link MaxIter}</li>
