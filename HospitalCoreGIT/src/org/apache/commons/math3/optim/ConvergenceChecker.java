 ...
 * does not use the point set at all. The third one considers that convergence
 * is reached when the input point set does not change much anymore, it does not
