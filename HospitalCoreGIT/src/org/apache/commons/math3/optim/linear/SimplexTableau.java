...
class SimplexTableau implements Serializable {
     ...
     *            Linear constraints.
     * @param goalType
     *            Optimization goal: either {@link GoalType#MAXIMIZE} or
     ...
     * @param col
     *            index of the column
     * @return the row that the variable is basic in, or {@code null} if the
    ...
    /**
     * Removes the phase 1 objective function, positive cost non-artificial
     * variables, and the non-basic artificial variables from this tableau.
     */
	...
	// need to update the basic variable mappings as row/columns have been
	// dropped
	...
	if (other instanceof SimplexTableau) {
	    ...
	    return (restrictToNonNegative == rhs.restrictToNonNegative)
		    ...
		    && (maxUlps == rhs.maxUlps) && f.equals(rhs.f) && constraints.equals(rhs.constraints)
	...
	return Boolean.valueOf(restrictToNonNegative).hashCode() ^ numDecisionVariables ^ numSlackVariables
		...
		^ constraints.hashCode() ^ tableau.hashCode();
    }
