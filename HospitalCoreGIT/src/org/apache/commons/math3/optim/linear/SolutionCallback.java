...
/**
 * A callback object that can be provided to a linear optimizer to keep track of
...
public class SolutionCallback implements OptimizationData {
     ...
     * <p>
     * <b>Note:</b> the returned solution may not be optimal, e.g. in case the
     * optimizer did reach the iteration limits.
     *
     * @return the best solution found so far by the optimizer, or {@code null}
