...
public class Erf {
    ...
    /**
     * The number {@code X_CRIT} is used by {@link #erf(double, double)}
     * internally. This number solves {@code erf(x)=0.5} within 1ulp. More
     * precisely, the current implementations of {@link #erf(double)} and
     * {@link #erfc(double)} satisfy:<br/>
     ...
     *
     * <p>
     * erf(x) = 2/&radic;&pi; <sub>0</sub>&int;<sup>x</sup>
     ...
     * gamma function}, following
     * <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3)
     * </p>
     *
     * <p>
     * The value returned is always between -1 and 1 (inclusive). If
     * {@code abs(x) > 40}, then {@code erf(x)} is indistinguishable from either
     * 1 or -1 as a double, so the appropriate extreme value is returned.
     * </p>
     *
     * @param x
     *            the value.
     ...
     *
     * <p>
     * erfc(x) = 2/&radic;&pi; <sub>x</sub>&int;<sup>&infin;</sup>
     ...
     * {@link Gamma#regularizedGammaQ(double, double, double, int) regularized
     * gamma function}, following
     * <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3).
     * </p>
     *
     * <p>
     * The value returned is always between 0 and 2 (inclusive). If
     * {@code abs(x) > 40}, then {@code erf(x)} is indistinguishable from either
     * 0 or 2 as a double, so the appropriate extreme value is returned.
     * </p>
     *
     * @param x
     *            the value
     ...
     *
     * The implementation uses either erf(double) or erfc(double) depending on
     * which provides the most precise result.
     *
     * @param x1
     *            the first value
     * @param x2
     ...
     * <p>
     * This implementation is described in the paper: <a href=
