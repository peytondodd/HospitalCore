...
public class RootsOfUnity implements Serializable {
    ...
    /**
     * Imaginary part of the {@code n}-th roots of unity, for positive values of
     * {@code n}. In this array, the roots are stored in counter-clockwise
     * order.
     */
    private double[] omegaImaginaryCounterClockwise;

    /**
     * Imaginary part of the {@code n}-th roots of unity, for negative values of
     * {@code n}. In this array, the roots are stored in clockwise order.
     */
     ...
     * <li>If {@code n > 0}, then the roots are stored in counter-clockwise
     * order.</li>
	...
	if ((k < 0) || (k >= omegaCount)) {
	    throw new OutOfRangeException(LocalizedFormats.OUT_OF_RANGE_ROOT_OF_UNITY_INDEX, Integer.valueOf(k),
