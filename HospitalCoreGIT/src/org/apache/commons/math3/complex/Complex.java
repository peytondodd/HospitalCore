 ...
 * </ul>
 * <p>
 * Note that this contradicts the IEEE-754 standard for floating point numbers
 * (according to which the test {@code x == x} must fail if {@code x} is
 * {@code NaN}). The method
 ...
 * this class conforms with the standard behavior for Java object types.
 * </p>
 *
 */
public class Complex implements FieldElement<Complex>, Serializable {
     ...
     * {@code Double.POSITIVE_INFINITY} if neither part is {@code NaN}, but at
     * least one part is infinite.
     *
    ...
    /**
     * Returns a {@code Complex} whose value is {@code (this + addend)}. Uses
     * the definitional formula
     * <p>
     * {@code (a + bi) + (c + di) = (a+c) + (b+d)i}
     * </p>
     * If either {@code this} or {@code addend} has a {@code NaN} value in
     * either part, {@link #NaN} is returned; otherwise {@code Infinite} and
     * {@code NaN} values are returned in the parts of the result according to
     * the rules for {@link java.lang.Double} arithmetic.
     *
     * @param addend
    ...
    /**
     * Returns the conjugate of this complex number. The conjugate of
     * {@code a + bi} is {@code a - bi}.
     * <p>
     * {@link #NaN} is returned if either the real or imaginary part of this
     * Complex number equals {@code Double.NaN}.
     * </p>
     * <p>
     * If the imaginary part is infinite, and the real part is not {@code NaN},
     * the returned value has infinite imaginary part of the opposite sign, e.g.
     * the conjugate of {@code 1 + POSITIVE_INFINITY i} is
     ...
     * </li>
     * <li>If {@code this} and {@code divisor} are both infinite, {@link #NaN}
     * is returned.</li>
     * <li>If {@code this} is finite (i.e., has no {@code Infinite} or
     * {@code NaN} parts) and {@code divisor} is infinite (one or both parts
     * infinite), {@link #ZERO} is returned.</li>
    ...
    /**
     * Test for equality with another object. If both the real and imaginary
     ...
     * Double}:
     * <ul>
     * <li>All {@code NaN} values are considered to be equal, i.e, if either (or
     * both) real and imaginary parts of the complex number are equal to
     * {@code Double.NaN}, the complex number is equal to {@code NaN}.</li>
     * <li>Instances constructed with different representations of zero (i.e.
     * either "0" or "-0") are <em>not</em> considered to be equal.</li>
     * </ul>
     *
     * @param other
     *            Object to test for equality with this instance.
     * @return {@code true} if the objects are equal, {@code false} if object is
     *         {@code null}, not an instance of {@code Complex}, or not equal to
     *         this instance.
     */
    @Override
    ...
    /**
     * Test for the floating-point equality between Complex objects. It returns
     * {@code true} if both arguments are equal or within the range of allowed
     * error (inclusive).
     *
     * @param x
     ...
     *            between the real (resp. imaginary) parts of {@code x} and
     *            {@code y}.
    ...
    /**
     * Get a hashCode for the complex number. Any {@code Double.NaN} value in
     * real or imaginary part produces the same hash code {@code 7}.
     *
     ...
     * has one or more infinite parts (same result is returned regardless of the
    ...
    /**
     * Returns a {@code Complex} whose value is {@code (-this)}. Returns
     * {@code NaN} if either real or imaginary part of this Complex number is
     * {@code Double.NaN}.
     *
     * @return {@code -this}.
     */
     ...
     * "_top"> hyperbolic cosine</a> of this complex number. Implements the
     * formula:
     * 
     * <pre>
     *  <code>
     ...
     * "_top"> natural logarithm</a> of this complex number. Implements the
     * formula:
     * 
     * <pre>
     *  <code>
     ...
     * </pre>
     * 
     * where ln on the right hand side is {@link FastMath#log}, {@code |a + bi|}
     ...
     * square root</a> of this complex number. Implements the following
     ...
     * "_top"> hyperbolic tangent</a> of this complex number. Implements the
     * formula:
     * 
     * <pre>
     *  <code>
     ...
     * essentially treating finite parts as zero in the presence of an infinite
     * coordinate and returning a multiple of pi/4 depending on the signs of the
     ...
     * element, {@link #NaN} is returned. if neither part is NaN, but at least
     * one part is infinite, the result is a one-element list containing
     * {@link #INF}.
     *
     * @param n
     *            Degree of root.
