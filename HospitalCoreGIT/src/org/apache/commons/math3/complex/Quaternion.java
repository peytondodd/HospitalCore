...
public final class Quaternion implements Serializable {
    ...
    /**
     * Computes the normalized quaternion (the versor of the instance). The norm
     * of the quaternion must not be zero.
     *
    ...
    /**
     * Checks whether this instance is equal to another quaternion within a
     * given tolerance.
     *
     * @param q
    ...
    /**
     * Gets the second component of the quaternion (first component of the
     * vector part).
     *
    ...
    /**
     * Gets the third component of the quaternion (second component of the
     * vector part).
     *
    ...
    /**
     * Gets the fourth component of the quaternion (third component of the
     * vector part).
     *
