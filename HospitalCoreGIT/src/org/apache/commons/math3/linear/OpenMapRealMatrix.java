...
public class OpenMapRealMatrix extends AbstractRealMatrix implements SparseRealMatrix, Serializable {
     ...
     *             if the total number of entries of the matrix is larger than
     ...
     *
     * @throws NumberIsTooLargeException
     *             if {@code m} is an {@code OpenMapRealMatrix}, and the total
     *             number of entries of the product is larger than
     *             {@code Integer.MAX_VALUE}.
     */
    @Override
     ...
     *             if the number of rows of {@code m} differ from the number of
     *             columns of {@code this} matrix.
     * @throws NumberIsTooLargeException
     *             if the total number of entries of the product is larger than
     *             {@code Integer.MAX_VALUE}.
     */
