 ...
 * preferable to solve either <center> (M &middot; A) &middot; x = M &middot; b
 * </center> (left preconditioning), or <center> (A &middot; M) &middot; y = b,
 * &nbsp;&nbsp;&nbsp;&nbsp;followed by M &middot; y = x </center> (right
 * preconditioning), where M approximates in some way A<sup>-1</sup>, while
 * matrix-vector products of the type M &middot; y remain comparatively easy to
 * compute. In this library, M (not M<sup>-1</sup>!) is called the
...
public abstract class PreconditionedIterativeLinearSolver extends IterativeLinearSolver {
     ...
     *             if {@code m}, {@code b} or {@code x0} have dimensions
     ...
     * solveInPlace}, and throws an exception if one of the checks fails.
     *
     * @param a
     *            the linear operator A of the system
     * @param m
