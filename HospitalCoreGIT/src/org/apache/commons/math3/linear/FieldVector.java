 ...
 * </pre>
 * <p>
 * Note that as almost all operations on {@link FieldElement} throw
 * {@link NullArgumentException} when operating on a null element, it is the
 * responsibility of <code>FieldVector</code> implementations to make sure no
 * null elements are inserted into the vector. This must be done in all
