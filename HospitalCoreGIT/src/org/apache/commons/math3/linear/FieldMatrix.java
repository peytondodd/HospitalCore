...
public interface FieldMatrix<T extends FieldElement<T>> extends AnyMatrix {
     ...
     *             if the number of columns of {@code this} matrix is not equal
     ...
     * @throws DimensionMismatchException
     *             if the number of columns of {@code m} differs from the number
     *             of rows of {@code this} matrix.
     */
     ...
     *             if {@code selectedRows} or {@code selectedColumns} is
     *             {@code null}.
     * @throws OutOfRangeException
     ...
     *            Final column index (inclusive).
     * @param destination
     *            The array where the submatrix data should be copied (if larger
     *            than rows/columns counts, only the upper-left part will be
     *            modified).
     * @throws MatrixDimensionMismatchException
     *             if the dimensions of {@code destination} are not large enough
     *             to hold the submatrix.
     * @throws NumberIsTooSmallException
    ...
    /**
     * Copy a submatrix. Rows and columns are indicated counting from 0 to n -
     * 1.
     *
     * @param selectedRows
     *            Array of row indices.
     ...
     *            Array of column indices.
     * @param destination
     *            Arrays where the submatrix data should be copied (if larger
     *            than rows/columns counts, only the upper-left part will be
     *            used)
     * @throws MatrixDimensionMismatchException
     *             if the dimensions of {@code destination} do not match those
     *             of {@code this}.
     * @throws NoDataException
     *             if {@code selectedRows} or {@code selectedColumns} is empty
     * @throws NullArgumentException
     ...
     * @return {@code v * this}
     * @throws DimensionMismatchException
     *             if the number of rows of {@code this} matrix is not equal to
