 ...
 * matrix A<sub>ij</sub>, this preconditioner is M = diag(1 / A<sub>11</sub>, 1
 * / A<sub>22</sub>, &hellip;).
 *
 * @since 3.0
 */
public class JacobiPreconditioner extends RealLinearOperator {
     ...
     *
     * @param a
     *            the linear operator for which the preconditioner should be
     *            built
     ...
     * precisely, this method returns P = diag(1 / &radic;A<sub>11</sub>, 1 /
     * &radic;A<sub>22</sub>, &hellip;).
     *
