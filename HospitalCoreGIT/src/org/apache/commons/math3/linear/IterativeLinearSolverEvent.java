...
public abstract class IterativeLinearSolverEvent extends IterationEvent {
     ...
     * @param iterations
     *            the number of iterations performed at the time {@code this}
     *            event is created
     */
     ...
     * true residual after some iterations. See e.g. A. Greenbaum and Z.
     * Strakos, <em>Predicting the Behavior of Finite Precision Lanzos and
     * Conjugate Gradient Computations</em>, Technical Report 538, Department of
     * Computer Science, New York University, 1991 (available <a href=
     * "http://www.archive.org/details/predictingbehavi00gree">here</a>).
     *
