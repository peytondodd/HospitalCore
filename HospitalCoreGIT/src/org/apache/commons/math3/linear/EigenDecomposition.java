 ...
 * </ul>
 * <p>
 * As of 3.1, this class supports general real matrices (both symmetric and
 * non-symmetric):
 * </p>
 * <p>
...
public class EigenDecomposition {
     ...
     *             if the decomposition of a general matrix results in a matrix
     *             with zero norm
     * @since 3.1
     */
    ...
    /**
     * Gets the matrix V of the decomposition. V is an orthogonal matrix, i.e.
     * its transpose is also its inverse. The columns of V are the eigenvectors
     * of the original matrix. No assumption is made about the orientation of
     * the system axes formed by the columns of V (e.g. in a 3-dimension space,
    ...
    /**
     * Gets the block diagonal matrix D of the decomposition. D is a block
     * diagonal matrix. Real eigenvalues are on the diagonal while complex
     * values are on 2x2 blocks { {real +imaginary}, {-imaginary, real} }.
     *
     * @return the D matrix.
     *
    ...
    /**
     * Gets the transpose of the matrix V of the decomposition. V is an
     * orthogonal matrix, i.e. its transpose is also its inverse. The columns of
     * V are the eigenvectors of the original matrix. No assumption is made
     * about the orientation of the system axes formed by the columns of V (e.g.
     * in a 3-dimension space, V can form a left- or right-handed system).
     *
     ...
     * @param i
     *            Index of the eigenvalue (counting from 0).
     * @return the imaginary part of the i<sup>th</sup> eigenvalue of the
     *         original matrix.
     *
     * @see #getD()
     * @see #getImagEigenvalues()
    ...
    /**
     * Computes the square-root of the matrix. This implementation assumes that
    ...
    /**
     * Gets a solver for finding the A &times; X = B solution in exact linear
     * sense.
     * <p>
     * Since 3.1, eigen decomposition of a general matrix is supported, but the
     * {@link DecompositionSolver} only supports real eigenvalues.
     *
     * @return a solver
     * @throws MathUnsupportedOperationException
	...
	public boolean isNonSingular() {
	    ...
	    // Looping over all values (in case they are not sorted in
	    // decreasing
	    // order of their norm).
	    for (int i = 0; i < realEigenvalues.length; ++i) {
	    ...
	    for (int i = 0; i < realEigenvalues.length; ++i) {
		// Looking for eigenvalues that are 0, where we consider
		// anything much much smaller
     ...
     *            Householder matrix of the transformation to tridiagonal form.
     */
