 ...
 * &times; T &times; P<sup>T</sup> with P an orthogonal matrix and T an
 * quasi-triangular matrix. Both P and T are m &times; m matrices.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This class is based on the method hqr2 in class EigenvalueDecomposition from
 * the <a href="http://math.nist.gov/javanumerics/jama/">JAMA</a> library.
 * </p>
 *
 ...
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Householder_transformation">Householder
 *      Transformations</a>
 * @since 3.1
 */
class SchurTransformer {
     ...
     * variable names as present in the original JAMA code.
     */
