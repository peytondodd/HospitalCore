...
public class SparseFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
     ...
     * use either the {@link #SparseFieldVector(SparseFieldVector, int)}
     * constructor or one of the {@code append} method
     * ({@link #append(FieldVector)} or {@link #append(SparseFieldVector)}) to
     * gather data into this vector.
     *
     * @param field
     *            Field to which the elements belong.
     */
