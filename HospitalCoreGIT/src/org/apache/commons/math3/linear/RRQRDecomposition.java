 ...
 * pivoting.
 * <p>
 * The rank-revealing QR-decomposition of a matrix A consists of three matrices
 * Q, R and P such that AP=QR. Q is orthogonal (Q<sup>T</sup>Q = I), and R is
 * upper triangular. If A is m&times;n, Q is m&times;m and R is m&times;n and P
 * is n&times;n.
 * </p>
 * <p>
...
public class RRQRDecomposition extends QRDecomposition {
	...
	// swap the current column with that with the greated L2-Norm and record
	// in p
     ...
     * right submatrices. When a large fall in norm is seen, the rank is
     * returned. The drop is computed as:
     * </p>
     * 
     * <pre>
     ...
     * is the Frobenius norm of the previous submatrix, rNorm is is the
     ...
     * {@link RRQRDecomposition#RRQRDecomposition(RealMatrix, double)
     * construction}, an error will be triggered when the
