...
public class DiagonalMatrix extends AbstractRealMatrix implements Serializable {
     ...
     *             if the dimension is not positive.
     */
    ...
    /**
     * Creates a matrix using the input array as the underlying data. <br/>
     * If an array is created specially in order to be embedded in a this
     * instance and not used directly, the {@code copyArray} may be set to
     ...
     * {@link #inverse(double)} if a different threshold is needed.
     *
