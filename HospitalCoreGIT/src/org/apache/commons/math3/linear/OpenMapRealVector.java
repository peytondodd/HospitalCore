...
public class OpenMapRealVector extends SparseRealVector implements Serializable {
     ...
     * use either the {@link #OpenMapRealVector(OpenMapRealVector, int)}
     * constructor or one of the {@code append} method ({@link #append(double)},
    ...
    /**
     * Computes the dot product. Note that the computation is now performed in
     * the parent class: no performance improvement is to be expected from this
     * overloaded method. The previous implementation was buggy and cannot be
     * easily fixed (see MATH-795).
     *
     * @param v
     *            Vector.
     ...
     *             performed by the parent class. The method must be kept to
	 ...
	 * this only. Indeed, if this[i] = 0d and v[i] = 0d, then this[i] / v[i]
	 * = NaN, and not 0d.
	 */
