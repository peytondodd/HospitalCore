...
public class MatrixUtils {
     ...
     *             if {@code data} is not rectangular (not all rows have the
     *             same length).
     ...
     *            If {@code true}, an exception will be raised if the matrix is
     *            not symmetric.
	...
	if (endColumn < startColumn) {
	    throw new NumberIsTooSmallException(LocalizedFormats.INITIAL_COLUMN_AFTER_FINAL_COLUMN, endColumn,
		    startColumn, false);
	}
     ...
     * @throws NullArgumentException
     *             if {@code selectedRows} or {@code selectedColumns} are
     *             {@code null}.
     * @throws NoDataException
     ...
     * {@link RealMatrix}.
     * <p>
     * This method is called to solve systems of equations which are of the
     * lower triangular form. The matrix {@link RealMatrix} is assumed, though
     * not checked, to be in lower triangular form. The vector
     * {@link RealVector} is overwritten with the solution. The matrix is
     * checked that it is square and its dimensions match the length of the
     * vector.
     * </p>
     * 
     * @param rm
     ...
     * @throws DimensionMismatchException
     *             if the matrix and vector are not conformable
     * @throws NonSquareMatrixException
     *             if the matrix {@code rm} is not square
     * @throws MathArithmeticException
     *             if the absolute value of one of the diagonal coefficient of
     ...
     * This method is called to solve systems of equations which are of the
     * lower triangular form. The matrix {@link RealMatrix} is assumed, though
     * not checked, to be in upper triangular form. The vector
     * {@link RealVector} is overwritten with the solution. The matrix is
     * checked that it is square and its dimensions match the length of the
     * vector.
     * </p>
    ...
    /**
     * Computes the inverse of the given matrix by splitting it into 4
     * sub-matrices.
     *
     * @param m
     *            Matrix whose inverse must be computed.
     * @param splitIndex
     *            Index that determines the "split" line and column. The element
     *            corresponding to this index will part of the upper-left
     *            sub-matrix.
     ...
     * QR-decomposition, unless a more efficient method can be determined for
     * the input matrix.
     * <p>
     * Note: this method will use a singularity threshold of 0, use
     * {@link #inverse(RealMatrix, double)} if a different threshold is needed.
     *
     * @param matrix
