 ...
 * {@link RealLinearOperator}. It follows closely the template by
 * <a href="#BARR1994">Barrett et al. (1994)</a> (figure 2.5). The linear system
 * at hand is A &middot; x = b, and the residual is r = b - A &middot; x.
 * </p>
 ...
 * differ from the true residual due to rounding-off errors (see e.g.
 * <a href="#STRA2002">Strakos and Tichy, 2002</a>).
 * </p>
 ...
 * {@link NonPositiveDefiniteOperatorException} if the linear operator or the
 * preconditioner are not positive definite. In this case, the
 ...
 * <dt>
 * <dd>Z. Strakos and P. Tichy,
 * <a href="http://etna.mcs.kent.edu/vol.13.2002/pp56-80.dir/pp56-80.pdf">
 * <em>On error estimation in the conjugate gradient method and why it works in
 * finite precision computations</em></a>, Electronic Transactions on Numerical
 * Analysis 13: 56-80, 2002</dd>
 * </dl>
 *
 * @since 3.0
 */
public class ConjugateGradient extends PreconditionedIterativeLinearSolver {
     ...
     *             if {@code a} or {@code m} is not positive definite
     */
    @Override
