...
public class Array2DRowRealMatrix extends AbstractRealMatrix implements Serializable {
     ...
     * the second argument set to {@code true}.
     * </p>
     *
     * @param d
     ...
     * array. If an array is built specially in order to be embedded in a
     * RealMatrix and not used directly, the {@code copyArray} may be set to
     * {@code false}. This will prevent the copying and improve performance as
     * no new array will be built and no data will be copied.
     *
     * @param d
     *            Data for new matrix.
     * @param copyArray
    ...
    /**
     * Create a new (column) RealMatrix using {@code v} as the data for the
     * unique column of the created matrix. The input array is copied.
     *
     * @param v
