...
public class ArrayFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
    ...
    /**
     * Build a 0-length vector. Zero-length vectors may be used to initialize
    ...
    /**
     * Construct a vector from an array, copying the input array. This
     * constructor needs a non-empty {@code d} array to retrieve the field from
     * its first element. This implies it cannot build 0 length vectors. To
     * build vectors from any size, one should use the
     * {@link #ArrayFieldVector(Field, FieldElement[])} constructor.
     *
     * @param d
     *            Array.
     ...
     * data array. If an array is built specially in order to be embedded in a
     * ArrayFieldVector and not used directly, the {@code copyArray} may be set
     * to {@code false}. This will prevent the copying and improve performance
     * as no new array will be built and no data will be copied. This
     * constructor needs a non-empty {@code d} array to retrieve the field from
     * its first element. This implies it cannot build 0 length vectors. To
     * build vectors from any size, one should use the
     * {@link #ArrayFieldVector(Field, FieldElement[], boolean)} constructor.
     *
     * @param d
     *            Data for the new vector.
     * @param copyArray
     *            If {@code true}, the input array will be copied, otherwise it
     *            will be referenced.
     * @throws NullArgumentException
     *             if {@code d} is {@code null}.
     * @throws ZeroException
     ...
     *             {@link #ArrayFieldVector(FieldVector, FieldVector)}
     */
    @Deprecated
     ...
     *             if {@code v1} or {@code v2} is {@code null}.
     * @deprecated as of 3.2, replaced by
     *             {@link #ArrayFieldVector(FieldVector, FieldElement[])}
     */
    @Deprecated
     ...
     *             if {@code v1} or {@code v2} is {@code null}.
     * @deprecated as of 3.2, replaced by
     *             {@link #ArrayFieldVector(FieldElement[], FieldVector)}
     */
    @Deprecated
    ...
    /**
     * Construct a vector by appending one vector to another vector. This
     * constructor needs at least one non-empty array to retrieve the field from
     * its first element. This implies it cannot build 0 length vectors. To
     * build vectors from any size, one should use the
     * {@link #ArrayFieldVector(Field, FieldElement[], FieldElement[])}
     * constructor.
     *
     * @param v1
     *            First vector (will be put in front of the new vector).
     ...
     *            Expected dimension.
     * @throws DimensionMismatchException
     *             if the dimension is not equal to the size of {@code this}
     *             vector.
     */
     ...
     *            this vector
     * @return the value returned by {@link FieldVectorChangingVisitor#end()} at
     *         the end of the walk
     * @since 3.3
     */
