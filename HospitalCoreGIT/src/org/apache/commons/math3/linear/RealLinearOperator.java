 ...
 * <a href="#BARR1994">Barrett et al. (1994)</a>: <blockquote> We restrict
 * ourselves to iterative methods, which work by repeatedly improving an
 * approximate solution until it is accurate enough. These methods access the
 * coefficient matrix A of the linear system only via the matrix-vector product
 * y = A &middot; x (and perhaps z = A<sup>T</sup> &middot; x). Thus the user
 * need only supply a subroutine for computing y (and perhaps z) given x, which
 * permits full exploitation of the sparsity or other special structure of A.
 * </blockquote> <br/>
 *
 * <dl>
 * <dt><a name="BARR1994">Barret et al. (1994)</a></dt>
 * <dd>R. Barrett, M. Berry, T. F. Chan, J. Demmel, J. M. Donato, J. Dongarra,
 * V. Eijkhout, R. Pozo, C. Romine and H. Van der Vorst, <em>Templates for the
 * Solution of Linear Systems: Building Blocks for Iterative Methods</em>, SIAM
 * </dd>
 * </dl>
 *
 * @since 3.0
...
public abstract class RealLinearOperator {
     ...
     *             if this operation is not supported by {@code this} operator
     */
