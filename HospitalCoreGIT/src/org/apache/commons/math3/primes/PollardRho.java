...
class PollardRho {
     ...
     * factorization algorithm" by Richard P. Brent. This avoids the triple
     * computation of f(x) typically found in Pollard's rho implementations. It
     * also batches several gcd computation into 1.
     * <p>
