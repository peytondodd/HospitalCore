...
/**
 * This interface allows users to add secondary differential equations to a
 * primary set of differential equations.
 * <p>
 * In some cases users may need to integrate some problem-specific equations
 * along with a primary set of differential equations. One example is optimal
 * control where adjoined parameters linked to the minimized Hamiltonian must be
 * integrated.
 * </p>
 * <p>
 * This interface allows users to add such equations to a primary set of
 * {@link FirstOrderFieldDifferentialEquations first order differential
...
public interface FieldSecondaryEquations<T extends RealFieldElement<T>> {
     ...
     * used by the equations to initialize some internal data if needed.
     * </p>
     * 
     * @param t0
     *            value of the independent <I>time</I> variable at integration
     *            start
     * @param primary0
     *            array containing the value of the primary state vector at
     *            integration start
     * @param secondary0
     *            array containing the value of the secondary state vector at
     *            integration start
     * @param finalTime
     ...
     * @param secondary
     *            array containing the current value of the secondary state
     *            vector
