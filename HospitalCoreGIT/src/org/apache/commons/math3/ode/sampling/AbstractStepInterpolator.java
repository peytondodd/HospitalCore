...
public abstract class AbstractStepInterpolator implements StepInterpolator {
     ...
     * <p>
     * This method can be used to restrict a step and make it appear as if the
     * original step was smaller. Calling this method <em>only</em> changes the
     * value returned by {@link #getPreviousTime()}, it does not change any
     * other property
     * </p>
     * 
     ...
     * This method can be used to restrict a step and make it appear as if the
     * original step was smaller. Calling this method <em>only</em> changes the
     * value returned by {@link #getCurrentTime()}, it does not change any other
     * property
     * </p>
     * 
