...
public enum StepNormalizerBounds {
    ...
    /**
     * Whether the first point should be passed to the underlying fixed step
     * size step handler.
     */
    private final boolean first;

    /**
     * Whether the last point should be passed to the underlying fixed step size
     * step handler.
     */
     ...
     * 
     * @param first
     *            Whether the first point should be passed to the underlying
     *            fixed step size step handler.
     * @param last
     *            Whether the last point should be passed to the underlying
     *            fixed step size step handler.
     */
    ...
    /**
     * Returns a value indicating whether the first point should be passed to
     * the underlying fixed step size step handler.
     * 
     * @return value indicating whether the first point should be passed to the
    ...
    /**
     * Returns a value indicating whether the last point should be passed to the
     * underlying fixed step size step handler.
     * 
     * @return value indicating whether the last point should be passed to the
     *         underlying fixed step size step handler.
     */
