...
/**
 * Container for time, main and secondary state vectors as well as their
 * derivatives.
 * 
...
public class FieldODEStateAndDerivative<T extends RealFieldElement<T>> extends FieldODEState<T> {
     ...
     * {@link #FieldODEStateAndDerivative(RealFieldElement, RealFieldElement[], RealFieldElement[], RealFieldElement[][], RealFieldElement[][])
