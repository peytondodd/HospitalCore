...
/**
 * Interface to compute exactly Jacobian matrix for some parameter when
 * computing {@link JacobianMatrices partial derivatives equations}.
 *
 * @since 3.0
 */
public interface ParameterJacobianProvider extends Parameterizable {
     ...
     * {@link #getParametersNames()}, the Jacobian will be set to 0, but no
     ...
     * @param yDot
     *            array containing the current value of the time derivative of
     *            the main state vector
     * @param paramName
     *            name of the parameter to consider
     * @param dFdP
     *            placeholder array where to put the Jacobian matrix of the ODE
