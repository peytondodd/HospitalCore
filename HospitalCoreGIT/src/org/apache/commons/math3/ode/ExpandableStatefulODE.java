 ...
 * add to this set another bunch of secondary equations which represent the
...
public class ExpandableStatefulODE {
	...
	if (components.isEmpty()) {
	    // there are no secondary equations, the complete set is limited to
	    // the primary set
	    return primaryMapper.getDimension();
	} else {
	    // there are secondary equations, the complete set ends after the
	    // last set
     ...
     * @param y
     *            array containing the current value of the complete state
     *            vector
     * @param yDot
	...
	for (final SecondaryComponent component : components) {
	    ...
	    component.equation.computeDerivatives(t, primaryState, primaryStateDot, component.state,
		    component.stateDot);
    ...
    /**
     * Add a set of secondary equations to be integrated along with the primary
     * set.
     * 
     * @param secondary
     ...
     * 
     * @param index
     *            index of the part to set as returned by
     *            {@link #addSecondaryEquations(SecondaryEquations)}
