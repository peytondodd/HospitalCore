...
public abstract class MultistepIntegrator extends AdaptiveStepsizeIntegrator {
     ...
     */
    protected void start(final double t0, final double[] y0, final double t) throws DimensionMismatchException,
	    NumberIsTooSmallException, MaxCountExceededException, NoBracketingException {
	 ...
	 * @param yDot
	 *            first steps derivatives
	 * @return Nordieck vector at first step (h<sup>2</sup>/2
