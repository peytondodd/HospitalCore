 ...
 * integrator} will be able to know where the primary set ends and so where the
 * secondary sets begin.
 * </p>
 *
...
public class FieldExpandableODE<T extends RealFieldElement<T>> {
     ...
     *         as the parameter to {@link FieldODEState#getSecondaryState(int)}
     *         and
     *         {@link FieldODEStateAndDerivative#getSecondaryDerivative(int)}
     *         (beware index 0 corresponds to main state, additional states
     *         start at 1)
     */
     ...
     *            start
     * @param y0
     *            array containing the value of the state vector at integration
     *            start
     * @param finalTime
