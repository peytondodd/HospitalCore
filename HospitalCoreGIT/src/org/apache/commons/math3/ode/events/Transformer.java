...
enum Transformer {
     ...
     * <p>
     * When this transformer is applied, the roots of the original function are
     * preserved, with the same {@code increasing/decreasing} status.
     * </p>
     */
    PLUS {
	/** {@inheritDoc} */
     ...
     * <p>
     * When this transformer is applied, the roots of the original function are
     * preserved, with reversed {@code increasing/decreasing} status.
     * </p>
     */
    MINUS {
	/** {@inheritDoc} */
    ...
    /**
     * Transformer computing transformed = min(-{@link Precision#SAFE_MIN}, -g,
     * +g).
     * <p>
     * When this transformer is applied, the transformed function is guaranteed
     * to be always strictly negative (i.e. there are no roots).
     * </p>
     */
    MIN {
	/** {@inheritDoc} */
    ...
    /**
     * Transformer computing transformed = max(+{@link Precision#SAFE_MIN}, -g,
     * +g).
     * <p>
     * When this transformer is applied, the transformed function is guaranteed
     * to be always strictly positive (i.e. there are no roots).
     * </p>
     */
    MAX {
	/** {@inheritDoc} */
