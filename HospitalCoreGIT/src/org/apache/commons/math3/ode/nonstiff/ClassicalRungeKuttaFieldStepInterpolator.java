 ...
 * &theta;<sup>2</sup>) (y'<sub>2</sub> + y'<sub>3</sub>) + ( -3 &theta; + 4
 * &theta;<sup>2</sup>) y'<sub>4</sub> ]</li>
 * <li>Using reference point at step end:<br>
 * y(t<sub>n</sub> + &theta; h) = y (t<sub>n</sub> + h) + (1 - &theta;) (h/6) [
 * (-4 &theta;^2 + 5 &theta; - 1) y'<sub>1</sub> +(4 &theta;^2 - 2 &theta; - 2)
 * (y'<sub>2</sub> + y'<sub>3</sub>) -(4 &theta;^2 + &theta; + 1) y'<sub>4</sub>
 * ]</li>
 * </ul>
 * </p>
 *
...
class ClassicalRungeKuttaFieldStepInterpolator<T extends RealFieldElement<T>>
	...
	return new ClassicalRungeKuttaFieldStepInterpolator<T>(newField, newForward, newYDotK, newGlobalPreviousState,
