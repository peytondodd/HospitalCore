...
public class DormandPrince54FieldIntegrator<T extends RealFieldElement<T>>
	...
	return new DormandPrince54FieldStepInterpolator<T>(getField(), forward, yDotK, globalPreviousState,
	...
	for (int j = 0; j < mainSetDimension; ++j) {
	    final T errSum = yDotK[0][j].multiply(e1).add(yDotK[2][j].multiply(e3)).add(yDotK[3][j].multiply(e4))
		    .add(yDotK[4][j].multiply(e5)).add(yDotK[5][j].multiply(e6)).add(yDotK[6][j].multiply(e7));
