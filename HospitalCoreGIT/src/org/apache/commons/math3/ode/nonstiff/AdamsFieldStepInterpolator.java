...
/**
 * This class implements an interpolator for Adams integrators using Nordsieck
 * representation.
 *
 * <p>
...
class AdamsFieldStepInterpolator<T extends RealFieldElement<T>> extends AbstractFieldStepInterpolator<T> {
     ...
     * @param reference
     *            reference state from which Taylor expansion are estimated
     * @param scaled
     *            first scaled derivative
     * @param nordsieck
     *            Nordsieck vector
    ...
    AdamsFieldStepInterpolator(final T stepSize, final FieldODEStateAndDerivative<T> reference, final T[] scaled,
	    ...
	    final FieldODEStateAndDerivative<T> globalCurrentState, final FieldEquationsMapper<T> equationsMapper) {
     ...
     * @param newForward
     *            integration direction indicator
     * @param newGlobalPreviousState
     *            start of the global step
     * @param newGlobalCurrentState
     *            end of the global step
     * @param newSoftPreviousState
     *            start of the restricted step
     * @param newSoftCurrentState
     *            end of the restricted step
     * @param newMapper
	...
	return new AdamsFieldStepInterpolator<T>(scalingH, reference, scaled, nordsieck, newForward,
		newGlobalPreviousState, newGlobalCurrentState, newSoftPreviousState, newSoftCurrentState, newMapper);
     ...
     *            reference state
     * @param time
     *            time at which state must be estimated
     * @param stepSize
     *            step size used in the scaled and Nordsieck arrays
     * @param scaled
     *            first scaled derivative
