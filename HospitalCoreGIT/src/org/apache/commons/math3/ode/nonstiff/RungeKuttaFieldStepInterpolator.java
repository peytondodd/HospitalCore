...
abstract class RungeKuttaFieldStepInterpolator<T extends RealFieldElement<T>> extends AbstractFieldStepInterpolator<T> {
	...
	return create(field, newForward, yDotK, newGlobalPreviousState, newGlobalCurrentState, newSoftPreviousState,
		newSoftCurrentState, newMapper);
    }
     ...
     * 
     * @param coefficients
     *            coefficients to apply to the method staged derivatives
